...
<div class="container text-center td-max-width-on-larger-screens">
  <div class="row">
    ...
    <div class="col hover-card">
        <a href="try-viam">
            <img src="img/tryviam.png" alt="Try the Viam rover" style="padding-top: 1em">
    ...
    <div class="col hover-card">
        <a href="installation">
            <img src="img/install.png" alt="Install the Viam Software" width=100% style="padding-top: 1em">
