...
---
This document lists known issues, common troubleshooting steps (e.g., check that the SBC plugged in and turned on, and so on) and common errors, and how we resolved them.
