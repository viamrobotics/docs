...
Different models of resources implement the same API, which [Viam SDKs expose](/architecture/machine-to-machine-comms/), allowing you to control different models of resource types with a consistent interface.
