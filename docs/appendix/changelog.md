...
You can now configure [triggers](/build/configure/triggers/) (previously called webhooks) to trigger actions when certain types of data are sent from your machine to the cloud.
