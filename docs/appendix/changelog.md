...
The [Viam Agent](/fleet/provision/) now supports [roaming mode](/fleet/provision/#use-roaming-mode). You can use the Viam Agent in roaming mode to allow it to attempt to connect to each specified WiFi network in your configuration.
