...
Viam includes a built-in [machine learning (ML) model service](/ml/vision/mlmodel/) which provides your machine with the ability to learn from data and adjust its behavior based on insights gathered from that data.
