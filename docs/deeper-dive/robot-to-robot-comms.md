...
[^grdoc]: gRPC's HTTP2 documentation: <a href="https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.m>" target="_blank">github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md</a>
