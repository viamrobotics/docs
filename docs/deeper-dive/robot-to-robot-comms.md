...
[^grdoc]: gRPC's HTTP2 documentation: <a href="https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md>" target="_blank">ht<span></span>tps://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md</a>
