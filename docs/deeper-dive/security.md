...
Every robot part has a secret key associated with it that, when starting up the RDK server, it uses to both ask the Viam App at [https://app.viam.com](https://app.viam.com) what its configuration file is as well as where to send logs to.
