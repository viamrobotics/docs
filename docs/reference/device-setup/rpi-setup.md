...
If you already have a Linux distribution installed on your {{< glossary_tooltip term_id="pi" text="Pi" >}}, you can skip ahead to [install `viam-server`](/foundation/).
...
If the value of "Architecture: _'xxxxxx'_" ends in "64", you can skip ahead to [install `viam-server`](/foundation/).
...
While the Imager is flashing your microSD card, we recommend reading [How to think about building a machine](/what-is-viam/).
