...
description: 'To view setup instructions for a machine part, navigate to the CONFIGURE tab, find the part''s card, click the "..." menu in the upper right corner of the card, and select "View setup instructions".'
aliases:
