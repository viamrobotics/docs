...
The base API allows you to give commands to your [base components](/hardware/common-components/add-a-base/) for moving all configured components attached to a platform as a whole without needing to send commands to individual components.
