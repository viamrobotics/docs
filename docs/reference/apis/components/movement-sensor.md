...
The movement sensor API allows you to give commands to your [movement sensor components](/hardware/common-components/add-a-movement-sensor/) for getting a GPS location, linear velocity and acceleration, angular velocity and acceleration and heading.
