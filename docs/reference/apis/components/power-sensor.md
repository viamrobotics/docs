...
The power sensor API allows you to give commands to your [power sensor components](/hardware/common-components/add-a-power-sensor/) for getting measurements of voltage, current, and power consumption.
