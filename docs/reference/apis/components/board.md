...
The board API allows you to give commands to your [board components](/hardware/common-components/add-a-board/) for setting GPIO pins to high or low, setting PWM, and working with analog and digital interrupts.
