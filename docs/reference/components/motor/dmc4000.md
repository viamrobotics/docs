...
weight: 60
type: "docs"
description: "Reference for the dmc4000 motor model. Stepper motor controlled by a DMC-40x0 series motion controller."
images: ["/icons/components/motor.svg"]
aliases:
  - "/operate/reference/components/motor/dmc4000/"
  - "/components/motor/dmc4000/"
  - "/reference/components/motor/dmc4000/"
...
The `DMC4000` model supports stepper motors controlled by [DMC-40x0 series motion controllers](https://www.galil.com/motion-controllers/dmc-4000).

Whereas a basic low-level stepper driver supported by the [`gpiostepper` model](/reference/components/motor/gpiostepper/) sends power to a stepper motor based on PWM signals from GPIO pins, the DMC40x0 motion controller has many motion control features.
When using it, you do not need to configure a [board component](/reference/components/board/) because it handles computation and signal creation on the motion controller itself.
