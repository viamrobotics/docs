...
You use orientation vectors to specify relative orientations of components when using the [motion service](/platform/build/configure/services/motion/) and [frame system](/platform/build/configure/services/frame-system/).
