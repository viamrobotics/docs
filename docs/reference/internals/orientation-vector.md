...
You use orientation vectors to specify relative orientations of components when using the [motion service](/mobility/motion/) and [frame system](/mobility/frame-system/).
