...
You use orientation vectors to specify relative orientations of components when using the [motion service](/build/configure/services/motion/) and [frame system](/build/configure/services/frame-system/).
