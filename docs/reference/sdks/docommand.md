...
You could [write a module](/build-modules/) that implements the [base API](/reference/apis/components/base/).
...
For an example that implements `DoCommand` in a generic API Python module, see [Add control logic to your module](/build-modules/).
