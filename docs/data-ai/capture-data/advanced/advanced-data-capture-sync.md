...
| `recent_data_store` | object | Optional | Specify the time frame for which to store the most recent data in a [hot data store](#capture-to-the-hot-data-store) for faster access. Example: `{ "stored_hours": 24 }` |
