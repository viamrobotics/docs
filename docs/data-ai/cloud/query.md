...
You can use the data management service to [capture sensor data](/data-ai/edge/sync/) from any machine and sync that data to the cloud.
...
See [capture sensor data](/data-ai/edge/capture-sync/) for more information.
...
Follow the guide to [capture sensor data](/data-ai/edge/capture-sync/).
...
On top of querying sensor data with third-party tools, you can also [query it with the Python SDK](/data-ai/reference/data-client/) or [visualize it](/data-ai/cloud/visualize/).
