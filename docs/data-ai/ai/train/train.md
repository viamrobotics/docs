---
linkTitle: "Train your own model"
...
For images, follow the instructions to [Create a dataset](/data-ai/ai/train/create-dataset/) to create a dataset and label data.
