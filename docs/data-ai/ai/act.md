...
Follow the steps in [Upload your module](/operate/modules/support-hardware/#upload-your-module) using cloud build.
When you create a release, your module will be built, packaged, and pushed to the Viam Registry.

If you are not using GitHub or cloud build, see [Upload your module](/operate/modules/support-hardware/#upload-your-module) and [Update an existing module](/operate/modules/advanced/manage-modules/#update-automatically-from-a-github-repo-with-cloud-build) for more information on alternatives.
