---
title: "Vision service tensor formats"
linkTitle: "Vision service tensor formats"
weight: 20
type: "docs"
...
The [Machine Learning (ML) model service](/data-ai/ai/train/deploy/) allows you to deploy machine learning models to your smart machine.
...
If you are [designing your own ML Model service](/data-ai/ai/train/deploy/), you must try to make your ML models' shapes match the input and output tensors the `mlmodel` vision service expects to work with if you want the two services to coordinate in classification or detection.
