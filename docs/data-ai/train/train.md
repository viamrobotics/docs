...
You can view your training job in the **Active Training** section on the [**MODELS** page](https://app.viam.com/models) or on the [**TRAINING** tab](https://app.viam.com/training).
