...
In the sidebar, click your arm component to open its card. Find the **Frame** section (arms always show it) and click **Set defaults**.
...
**Gripper** (attached directly to the end effector). In the sidebar, click your gripper component to open its card. Find the **Frame** section (grippers always show it) and click **Set defaults**, then edit the values:
