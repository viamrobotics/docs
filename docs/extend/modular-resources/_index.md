...
[Find in-depth API creation instructions in the New Subtype documentation.](create-subtype/)
...
![Creation of a new module in the Viam app config builder.](/program/modular-resources/module-ui-config.png)
