...
![Creation of a ultrasonic sensor in the Viam app config builder.](/micro-rdk/ultrasonic/ultrasonic-sensor-ui-config.png)
...
| --------- | ---- | --------- | ----------- |
| `trigger_pin` | string | **Required** | The GPIO number of the [board's](/micro-rdk/board/) GPIO pin that you have wired to the trigger pin of your ultrasonic sensor. |
