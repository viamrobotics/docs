...
The [micro-RDK](/installation/#install-the-micro-rdk) works differently from the RDK (and `viam-server`), so creating modular resources for it is different from the process described on this page.
