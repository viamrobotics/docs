...
After physically setting up the hardware on your base, create an account and add a machine, [install `viam-server`](/installation/), and [configure your rover base](/components/base/).
