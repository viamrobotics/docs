...
On top of visualizing sensor data with third-party tools, you can also [query it with the Python SDK](/appendix/apis/components/sensor/) or [query it with the Viam app](/how-tos/sensor-data-query-with-third-party-tools/).
