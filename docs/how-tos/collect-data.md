...
For example, if you have a Sensirion SHT3x-DIS temperature and humidity sensor, you should use the [`sensirion-sht3xd`](https://github.com/viam-modules/sensirion/tree/main/sht3xd) model of sensor.
