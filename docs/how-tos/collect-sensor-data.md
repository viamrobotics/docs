...
If you need to sync data conditionally, for example at a certain time, see [Trigger Sync](/how-tos/trigger-sync/#configure-data-manager-to-sync-based-on-sensor).
{{< /alert >}}
