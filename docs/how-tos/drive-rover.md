...
If you are using your own robot for this tutorial instead of [borrowing one](https://app.viam.com/try), be sure to [install `viam-server`](/installation/#install-viam-server) on it, connect and [configure](/tutorials/configure/configure-rover/) its hardware before proceeding with this tutorial.
{{% /alert %}}
