...
icon: true
images: ["/machine/services/icons/data-cloud-sync.svg"]
aliases:
  - "/machine/services/app/data/cloud-sync/"
# SME: Alexa Greenberg
---
...
Before you can configure [cloud sync](/app/data/cloud-sync/), you must [add the data management service](/app/data/capture/#add-the-data-management-service).
...
To set up triggers for syncing see [Trigger Sync](/app/data/trigger-sync/).
...
![service config example](/app/data/data-service-config.png)
...
- **Storage** Data that is successfully synced to the cloud is automatically deleted from local storage.
  ...
  See [automatic data deletion](/app/data/capture/#automatic-data-deletion) for configuration options.

  {{< /alert >}}

## Next steps

To view your captured data in the cloud, see [View Data](/app/data/view/).

To export your captured data from the cloud, see [Export Data](/app/data/export/).
