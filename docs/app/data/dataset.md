...
images: ["/app/data/label-dog.gif"]
videos: ["/app/data/label-dog.webm", "/app/data/label-dog.mp4"]
videoAlt: "Add a bounding box around the dog in an image."
aliases:
  - /manage/app/data/label/
  - /manage/app/data/dataset/
...
To label data, go to the [**DATA** tab](https://app.viam.com/app/data/view) in the Viam app.
...
- [Bounding boxes](#bounding-boxes), which you can use to [train object detection models](/app/ml/train-model/#train-a-model).
- [Image tags](#image-tags), which you can use to train [image classification models](/app/ml/train-model/#train-a-model).

### Bounding boxes

You can create one or more bounding boxes for objects in each image.
If you annotate an entire dataset, you can use these bounding boxes to [create object detection models](/app/ml/train-model/#train-a-model).
...
{{<gif webm_src="/app/data/label-dog.webm" mp4_src="/app/data/label-dog.mp4" alt="Add a bounding box around the dog in an image">}}

If you want to expand the image, click on the expand side menu arrow in the corner of the image:

{{<gif webm_src="/app/data/label-dog-big.webm" mp4_src="/app/data/label-dog-big.mp4" alt="Add a bounding box around the dog in an image in a big menu">}}
...
You can use tags to [create classification models](/app/ml/train-model/#train-a-model) for images.
...
{{<gif webm_src="/app/data/tag-star.webm" mp4_src="/app/data/tag-star.mp4" alt="Tag image with a star label">}}
...
To create a dataset, go to the [**DATA** tab](https://app.viam.com/app/data/view) in the Viam app.
...
{{<gif webm_src="/app/data/add-to-dataset.webm" mp4_src="/app/data/add-to-dataset.mp4" alt="Add image to dataset">}}

You can also create a new dataset from the [**DATASETS** subtab](https://app.viam.com/app/data/datasets).
Click **Create dataset**, enter a name or use the suggested name for your dataset and click **Create dataset** again.

![Create dataset UI](/app/data/create-dataset.png)
...
{{<gif webm_src="/app/data/delete-from-dataset.webm" mp4_src="/app/data/delete-from-dataset.mp4" alt="Remove from dataset">}}
...
Once you have added data to your dataset, you can view the data in your dataset by clicking on your dataset's name on the image sidebar or on the [**DATASETS** subtab](https://app.viam.com/app/data/datasets).
...
To train a model on a dataset, see [Train a model](/app/ml/train-model/).

### Rename a dataset

To rename a dataset, go to the [**DATASETS** subtab](https://app.viam.com/app/data/datasets).
...
To delete a dataset, go to the [**DATASETS** subtab](https://app.viam.com/app/data/datasets), right click on the dataset and click on **Delete** in the menu that appears.
