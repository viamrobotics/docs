...
no_list: true
aliases:
  - "/machine/services/app/data/capture/"
# SME: Alexa Greenberg
---
...
Data capture is frequently used with [Cloud Sync](/app/data/cloud-sync/).
...
![component config example](/app/data/data-service-component-config.png)
...
If [cloud sync](/app/data/cloud-sync/) is enabled, the data management service deletes captured data once it has successfully synced to the cloud.
...
{{<imgproc src="/app/data/data-icon.png" resize="300x" declaredimensions=true alt="Data icon">}}
...
{{<imgproc src="/app/data/part-menu.png" resize="300x" declaredimensions=true alt="Machine menu with the options Rename, Restart part, View captured data, View setup instructions, View history, View debug configuration, and Delete machine">}}
...
![Resource menu with the options Rename, Duplicate, View captured data, and Delete](/app/data/resource-menu.png)

To view all the captured data you have access to, see [View Data](/app/data/view/).
...
To sync your captured data with the cloud, [configure cloud sync](/app/data/cloud-sync/).

If you have synced tabular data, such as [sensor](/machine/components/sensor/) readings, you can [query that data with SQL or MQL](/app/data/query/) from the Viam app or a MQL-compatible client.
If you have synced images, you can use those images to [train machine learning models](/app/ml/train-model/) within the Viam app.

For a comprehensive tutorial on using data capture and synchronization together with the ML model service, see [Capture Data and Train a Model](/tutorials/services/data-mlmodel-tutorial/).

To learn how to capture Performance Metrics for machines, see [Performance Monitoring Data Capture](/app/data/capture/performance-metrics/).

{{< cards >}}
{{% card link="/tutorials/services/data-mlmodel-tutorial/" %}}
{{% card link="/app/data/capture/performance-metrics/" %}}
