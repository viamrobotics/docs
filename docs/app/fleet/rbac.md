...
- **Owner**: Can see and edit [every tab on the machine page](/app/fleet/machines/#navigating-the-machine-page).
  Can manage users in the app.
- **Operator**: Can see and use only the [**CONTROL**](/app/fleet/control/) tab.
  Cannot see or edit the [**CONFIGURE**](/app/fleet/machines/#configure), [**LOGS**](/app/fleet/machines/#logs), or **CONNECT** tabs.

For more detailed information on the permissions each role confers for different resources, see [Permissions](/app/fleet/rbac/#permissions).

## Change a user's access

If you have the **Owner** role, you can [invite new users](/app/fleet/organizations/#invite-someone-to-an-organization) and change the roles assigned to an organization member on a per machine, location, or organization level.
...
{{<imgproc src="/app/fleet/rbac.png" resize="700x" declaredimensions=true alt="Organization page">}}
...
{{< imgproc alt="The user invitation menu on the Organization settings page." src="/app/fleet/app-usage/limit-access.png" resize="800x" declaredimensions=true >}}

For more information on the permissions the roles assign for each resource, see [Permissions](/app/fleet/rbac/#permissions).
...
{{< imgproc alt="The user invitation menu on the Organization settings page." src="/app/fleet/app-usage/grant-access.png" resize="800x" declaredimensions=true >}}
...
You can also use the [Viam mobile app](/app/fleet/#the-viam-mobile-app) to grant or revoke organization owner or operator access to users on the go.
...
{{<imgproc src="/app/fleet/api-keys.png" resize="700x" declaredimensions=true alt="API Keys table">}}
...
{{<imgproc src="/app/fleet/additional-details.png" resize="700x" declaredimensions=true alt="Additional details for a key">}}
...
Permissions for [data management](/app/data/) and [machine learning](/ml/) are as follows:
