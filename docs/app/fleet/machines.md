...
images: ["/app/fleet/app-usage/create-machine.png"]
aliases:
  - /app/fleet/robots/
  - /manage/app/fleet/machines/
---
...
![The machine page with part menu expanded](/app/fleet/app-usage/machine-page.png)
...
{{<imgproc src="/app/fleet/app-usage/parts-live.png" resize="400x" declaredimensions=true alt="The machine page with all parts live">}}
...
For more information, see the [configuration documentation](/machine/configure/#the-configure-tab).

{{< alert title="Tip" color="tip" >}}
If you are managing a large fleet, you can use {{< glossary_tooltip term_id="fragment" text="fragments" >}} when [configuring your fleet](/app/fleet/configure-a-fleet/).
{{< /alert >}}

### CONTROL

Once you have configured components and services for your machine, you can visually test and remotely operate them from the **CONTROL** tab in the [Viam app](https://app.viam.com) or the [Viam mobile app](/app/fleet/#the-viam-mobile-app).

For more information, see [Control machines](/app/fleet/control/).

{{<gif webm_src="/app/fleet/control.webm" mp4_src="/app/fleet/control.mp4" alt="Using the control tab" max-width="800px">}}
...
{{<gif webm_src="/app/fleet/log-filtering.webm" mp4_src="/app/fleet/log-filtering.mp4" alt="Filter logs by term of log level in the UI" max-width="800px">}}
...
For more information on the SDKs, see [Program your Machine with Viam's SDKs](/program/apis/).

#### Configure as remote part

On the **CONNECT** tab, there is also a page called **Configure as remote part**.
This page has instructions for how to configure a {{< glossary_tooltip term_id="part" text="part" >}} of your machine as a [remote part](/machine/configure/parts/) of another machine.
...
The **API keys** page of the **CONNECT** tab allows you to access, generate, and delete your [API keys](/app/fleet/rbac/#api-keys), which grant access to organizations, locations, and machines.

![The Security tab of a machine's page noting the Machine part API keys dropdown menu, with the clipboard icon on the far right and the Generate Key button underneath the dropdown.](/app/fleet/app-usage/machine-secrets.png)
...
{{< imgproc alt="The delete machine button and the confirmation checkbox (Sure?) next to it." src="/app/fleet/app-usage/delete.png" resize="300x" >}}
