...
aliases:
  - /manage/app/fleet/organizations/
---
...
You can also use organizations for departments or other entities that can have one or more [locations](/app/fleet/locations/).
If you are familiar with Google Drive, you can think of an organization as a shared drive.

{{<imgproc src="/app/fleet/rbac.png" resize="900x" declaredimensions=true alt="Organization page">}}
...
{{< imgproc alt="The org dropdown showing an example user's name, email, Sign out button, list of organizations, and org settings button." src="/app/fleet/app-usage/my-org.png" resize="400x" declaredimensions=true >}}
...
{{< imgproc alt="The user invitation menu on the Organization settings page." src="/app/fleet/app-usage/invite-user.png" resize="900x" declaredimensions=true >}}
...
You can also use the [Viam mobile app](/app/fleet/#the-viam-mobile-app) to invite users to your organization, on the go. Navigate to Home on the mobile app, and select your organization. Click the gear icon in the upper right corner to access the mobile organization settings page. On the settings page enter an email address, select a role, and tap **Grant Access**.

### Create a namespace for your organization

When uploading [custom modules](/app/registry/) to the Viam registry, you must set a namespace for your organization to associate your module with.
...
{{< imgproc alt="The namespace creation menu on the Organization settings page." src="/app/fleet/app-usage/create-namespace.png" resize="700x" declaredimensions=true >}}
