...
You can manage and control your fleet of {{< glossary_tooltip term_id="machine" text="smart machines" >}} from the [Viam app](https://app.viam.com), using the [CLI](/cli/), or using the [fleet management API](/program/apis/app/fleet/).
...
{{< cards >}}
{{% manualcard link="/app/fleet/organizations/" %}}
...
{{% /manualcard %}}
{{% manualcard link="/app/fleet/locations/" %}}
...
{{% /manualcard %}}
{{% manualcard link="/app/fleet/machines/" %}}
...
{{<imgproc src="/app/fleet/fleet.svg" resize="1400x" style="max-width: 1400px" declaredimensions=true alt="A diagram showing how organizations, locations, and machines are grouped by Viam's fleet management">}}

<br><br>

The organization structure enables you to:

- configure groups of machines with reusable {{< glossary_tooltip term_id="fragment" text="fragments" >}} that [configure](/machine/configure/) a set of resources for each machine that uses the fragment.
- deploy [code packages](/app/registry/) or [machine learning models](/ml/), without manually copying files by uploading it to Viam's cloud and deploying it to your fleet
...
For more information, see [Permissions](/app/fleet/rbac/#permissions).
...
Machine [configuration](machines/#configure) and machine [code](/program/) is intentionally kept separate, allowing you to keep track of versioning and debug issues separately.

## The Viam mobile app

{{<gif webm_src="/app/fleet/mobile-app-octagon.webm" mp4_src="/app/fleet/mobile-app-octagon.mp4" alt="GIF of red button being pressed and cannon of confetti bot spraying confetti" class="alignright" max-width="200px">}}
...
- access the [control interface](/app/fleet/control/) for each machine
- [invite people to collaborate with you and modify access](/app/fleet/rbac/#use-the-mobile-app)
- check machine [logs](/app/fleet/machines/#logs)
- [upload images from your phone to the cloud](/app/data/upload/#upload-images-with-the-viam-mobile-app)
