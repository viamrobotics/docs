...
{{<imgproc src="/app/fleet/billing-menu.png" resize="400x" declaredimensions=true alt="Payment and billing menu item" class="alignright">}}
...
![Payment and billing overview](/app/fleet/billing-overview.png)
