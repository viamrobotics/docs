...
For more information on the permissions the roles assign for each resource, see [Permissions](/app/fleet/rbac/#locations).
...
![The Add Organization dropdown in the Viam app displays all organizations the user is a member of.](/app/fleet/app-usage/add-org-drop-down.png)

The location's page lists the newly added organization, along with the organization identified as the _primary owner_:

![After adding another org, the Viam app lists it under the orgs that share this location list.](/app/fleet/app-usage/after-add-org.png)
...
![The list of secret keys that can grant access to a location displays in the location secret keys dropdown menu of the Viam app.](/app/fleet/app-usage/location-secret-keys-dropdown.png)
