...
images: ["/app/fleet/control.gif"]
---

Once you have [configured components and services](/machine/configure/) for your machine, you can test, monitor, and remotely operate them from the **CONTROL** tab in the [Viam app](https://app.viam.com) or the [Viam mobile app](/app/fleet/#the-viam-mobile-app).
...
For local communication between [parts](/machine/configure/parts/#machine-parts) Viam uses gRPC or WebRTC.
...
- [SLAM](/machine/services/slam/cartographer/#create-a-new-map): for creating a new SLAM map and for using the motion service to move a machine on a SLAM map
- [Navigation](/machine/services/navigation/#control-tab-usage): for moving a machine to waypoints on a map

## Control interface in the Viam mobile app

The [Viam mobile app](/app/fleet/#the-viam-mobile-app) gives you the ability to test, monitor and remotely operate machines in your fleet.
...
{{<gif webm_src="/app/fleet/mobile-app-control.webm" mp4_src="/app/fleet/mobile-app-control.mp4" alt="Using the control interface under the locations tab on the Viam mobile app" max-width="300px">}}

Additionally, the machine control interface provides a menu for:

- [viewing a machine's logs](/app/fleet/machines/#logs)
- [uploading images from your phone to the cloud](/app/data/upload/#upload-images-with-the-viam-mobile-app)
