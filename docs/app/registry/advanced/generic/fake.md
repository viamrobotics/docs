...
![An example configuration for a fake generic service in the Viam app Config Builder.](/machine/services/fake-generic-service-config.png)
...
See [GitHub](https://github.com/viamrobotics/rdk/blob/main/machine/services/generic/fake/generic.go) for API call return specifications.
