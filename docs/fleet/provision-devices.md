...
If you do not yet have a {{< glossary_tooltip term_id="fragment" text="fragment" >}}, follow the steps to [Create a fragment](/fleet/reuse-configuration/#create-a-fragment) and make a note of the fragment ID.
