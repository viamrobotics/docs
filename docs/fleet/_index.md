...
You can manage your fleet of machines from the Viam app or using the [cloud API](/build/program/apis/cloud/).
...
If you are managing a fleet, you can use {{< glossary_tooltip term_id="fragment" text="fragments" >}} when [configuring your robots](/build/configure/configuration/), allowing you to use the same configuration for multiple robots.
...
You and your collaborators can deploy control logic, {{< glossary_tooltip term_id="modular-resource" text="modular resources" >}}, sidecar [processes](/build/configure/configuration/#processes), or [machine learning models](/build/configure/services/ml/) to your fleet of robots without manually copying files by uploading it to Viam's cloud and deploying it to your fleet.
...
You and your collaborators can deploy [control logic](/build/program/apis/), [modular resources](/registry/), sidecar [processes](/build/configure/configuration/#processes), or [machine learning models](/build/configure/services/ml/) to your fleet of robots without manually copying files by uploading it to Viam's cloud and deploying it to your fleet.
...
The mobile app is a convenient way to see if your robot is online, access the [control interface](/fleet/robots/#control), and check robot [logs](/fleet/robots/#logs).
