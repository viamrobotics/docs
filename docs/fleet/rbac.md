...
- **Operator**: Can see and use only the [**Control** tab](/fleet/machines/#control).
  Cannot see or edit the [**Setup**](/fleet/machines/#setup), [**CONFIGURE**](/fleet/machines/#configuration), [**History**](/fleet/machines/#history), [**Logs**](/fleet/machines/#logs), [**Code sample**](/fleet/machines/#code-sample), or [**Security**](/fleet/machines/#security) tabs.
