...
2. Use the **Add Viam Support** button on your machine's Location page to give Viam Support access to your _location_.
   Refer to [Managing Locations and sub-locations](/app/fleet/locations/).
...
Your machine belongs to the [organization](/app/fleet/organizations/) you were in when you made the request.

## Can I share this Location with a friend to work on the machine together?

Sure, you can [invite other users to your organization](/app/fleet/locations/) to collaborate on your machine.
