...
{{< imgproc src="/services/base-rc/base-rc-ui-config.png" alt="An example configuration for a Base Remote Control service in the Viam app Config Builder." resize="1000x" declaredimensions=true >}}
