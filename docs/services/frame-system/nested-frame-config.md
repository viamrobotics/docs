...
{{< imgproc src="/services/frame-system/frame_card_dyn_gantry.png" alt="gantry frame card example for this configuration" resize="1000x" declaredimensions=true >}}
...
{{< imgproc src="/services/frame-system/frame_card_dyn_arm.png" alt="arm frame card example for this configuration" resize="1000x" declaredimensions=true >}}
