...
![Example robot's default frame configuration shown in the Frame System Editor. All components are stuck on top of each other](/services/frame-system/demo_base_unedited.png)
...
![Non-default Orthographic Camera view shown in the Frame System Editor](/services/frame-system/demo_orthographic.png)
