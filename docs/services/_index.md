...
If you would like to use additional service types, you can [extend Viam with custom services](/program/extend/modular-resources/#add-a-module-to-your-robot-configuration).
