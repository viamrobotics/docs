...
Follow [these instructions](/program/extend/modular-resources/examples/add-rplidar-module/) to add your Rplidar device as a modular component of your robot.
