...
To use Cartographer with the Viam [SLAM service](/services/slam/), you can use the [`cartographer`](https://app.viam.com/module/viam/cartographer) [modular resource](/extend/modular-resources/).
...
1. Adjust the config parameters as needed.
