...
| `delete_data_on_part_deletion` | bool | Optional | Whether deleting this machine part or this machine should result in deleting all the data captured by that machine part. <br> Default: `false` | <p class="center-text"><i class="fas fa-check" title="yes"></i></p> |
