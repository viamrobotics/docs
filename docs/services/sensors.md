...
weight: 70
type: "docs"
description: "The Sensors Service is a builtin service that provides a central interface to all of your robot's sensors."
...
The Sensors Service is a builtin service that provides a central interface to all of your robot's [sensors](/components/sensor), regardless of the sensor model.
...
[`Readings`](#readings) | Returns a list of sensor readings from a given list of sensors.
