...
Use the name `"builtin"` to access the built-in motion service in your code with methods like [`FromRobot()`](/services/motion/#fromrobot) that require a `ResourceName`.
