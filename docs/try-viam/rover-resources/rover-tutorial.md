...
To drive your rover, [add the Viam Fragment to your Robot](/try-viam/rover-resources/rover-tutorial-fragments/).
...
- For [lidar](/services/slam/run-slam-cartographer), we recommend Velodyne, or RPLIDAR (including A1, which is a sub-$100 LIDAR).
