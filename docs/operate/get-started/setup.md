...
Once the machine has a configuration, it caches it locally (in a file at <FILE>~/.viam/cached\_cloud\_config\<PART-ID\>.json</FILE>) and can use the config for up to 60 days.
