...
If a module appears in both a {{< glossary_tooltip term_id="fragment" text="fragment" >}} and the part configuration, Viam will import the most recent configured version of the module.
