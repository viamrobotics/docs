...
1. Update the `meta.json` file to reflect the new organization:
   ...
   - Change the first part of the `module_id` field to the new organization's [namespace](/operate/getting-started/other-hardware/naming-modules/#create-a-namespace-for-your-organization).
