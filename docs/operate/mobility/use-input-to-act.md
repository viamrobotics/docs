...
See [Act based on inferences](/data-ai/infer/act/) for relevant examples.

If you want to send alerts based on computer vision or captured data, see [Alert on inferences](/data-ai/infer/alert/) or [Alert on data](/data-ai/infer/alert-data/).
