...
For the Raspberry Pi AI cameras like the IMX500 AI camera, you can use this [vision service module](https://github.com/HipsterBrown/viam-pi-ai-camera), but this is not officially supported by Viam.
