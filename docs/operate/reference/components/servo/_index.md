...
If you have an industrial servo motor, configure or [create](/operate/get-started/other-hardware/create-module/) a [motor component](/operate/reference/components/motor/) that supports your hardware.
