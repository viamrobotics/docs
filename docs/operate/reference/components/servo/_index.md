...
If you have an industrial servo motor, configure or [create](/operate/modules/write-a-driver-module/) a [motor component](/operate/reference/components/motor/) that supports your hardware.
