...
If none of the existing models fit your use case, you can [create a modular resource](/operate/get-started/other-hardware/create-module/) to add support for it.
{{< /alert >}}
