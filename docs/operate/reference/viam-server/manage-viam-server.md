...
## Downgrade `viam-server`

In some cases, you may need to install an older version of `viam-server`. This is particularly useful for testing or when a newer version has compatibility issues with your setup.

{{< tabs name="Downgrading viam-server" >}}
{{% tab name="macOS" %}}
...
cd /opt/homebrew/Homebrew/Library/Taps/viamrobotics/homebrew-brews/
