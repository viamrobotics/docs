...
- First, [configure your frame system](/operate/reference/services/frame-system/#configuration) to configure the relative spatial orientation of the components of your machine, including your [camera](/operate/reference/components/camera/), within Viam's frame system.
