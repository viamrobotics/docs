...
Go to your machine's page and navigate to the **CONFIGURE** tab.
...
Go to your machine's page and navigate to the **CONFIGURE**.
...
| `sensors` | string[] | **Required** | Names of any configured [webcams](/operate/reference/components/camera/) providing data to the SLAM service. |
