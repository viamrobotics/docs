...
Components with complex kinematic chains require an additional set of intermediate reference frames to use the [motion service](/operate/reference/services/motion/).
