...
{{% alert title="Note for Mac users" color="note" %}}
`viam-server` can run on Macs, but not all {{< glossary_tooltip term_id="module" text="modules" >}} support Macs.
{{% /alert %}}
...
1. Create a new _{{< glossary_tooltip term_id="machine" text="machine" >}}_ using the **Add machine** button in the top right corner of the **LOCATIONS** tab in the app.
