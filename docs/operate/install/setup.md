...
1. Create a new [_{{< glossary_tooltip term_id="machine" text="machine" >}}_](/operate/hello-world/quickstart/#what-is-a-machine) using the **Add machine** button in the top right corner of the **LOCATIONS** tab in the app.
