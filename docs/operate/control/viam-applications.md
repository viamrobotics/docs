...
| `models` | array | Optional | Deprecated. Empty unless you are shipping the app alongside models. For information on how to add models, see [Support hardware and software](/operate/modules/support-hardware/). |
