...
The robot Viam cloud address in the code sample generated by the Viam app is an example of connecting to the robot through an external or public address: for example, [`12345.somerobot-main.viam.cloud`].
