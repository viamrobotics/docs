...
If you are connecting to your robot through an external signaling address, as is the case in the boilerplate code samples generated by the Viam app, you can perform this step on any computer.
This is useful because as long as this computer is able to establish a network connection with the robot's computer, the control logic will be executed on the robot.
