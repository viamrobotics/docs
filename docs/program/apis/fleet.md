...
aliases:
  - /program/apis/app/fleet/
  - /program/apis/app/fleet/
---

The fleet management API allows you to [manage your machine fleet](/app/fleet/) with code instead of with the graphical interface of the [Viam app](https://app.viam.com/).
With it you can
...
Mark a machine part as the [_main_ part](/machine/configure/parts/#machine-parts) of a machine.
...
For more information about managing permissions, see [Role-Based Access Control](/app/fleet/rbac/#permissions).
