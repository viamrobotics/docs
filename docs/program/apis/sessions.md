...
The session management API moderates `viam-server`'s client network connections, like the star to `viam-server`'s planet in an solar system of application clients:
