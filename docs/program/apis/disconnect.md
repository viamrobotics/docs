...
If your robot running `viam-server` is no longer connected to the internet and the session is ended, all operations will timeout automatically and operations will be halted.
