...
A *robot* in Viam consists of at least one computer, typically a [single-board computer](/installation/prepare/) that communicates with any hardware connected to it by signaling through digital data pins.
Viam supports any device running a 64-bit Linux OS or macOS.
