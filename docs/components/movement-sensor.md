...
Any movement sensor that uses I<sup>2</sup>C must be connected to a board that supports I<sup>2</sup>C and [has it enabled](../../getting-started/rpi-install/#enabling-specific-communication-protocols-on-the-raspberry-pi).
{{% /alert %}}
