...
Review the [instructions in our documentation](https://docs.viam.com/getting-started/rpi-install/#enabling-the-i2c-protocol-on-the-raspberry-pi) to learn how to enable I2C on a Raspberry Pi 4.
