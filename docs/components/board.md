...
Review the [instructions in our documentation](/installation/rpi-setup/#enabling-the-i2c-protocol-on-the-raspberry-pi) to learn how to enable I2C on a Raspberry Pi 4.
