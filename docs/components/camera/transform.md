...
- `max_classifications`: The maximum number of classifications to display on the camera stream at any given time.
- `valid_labels`: An array of labels that you to see detections for on the camera stream.
