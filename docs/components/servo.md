...
| `pwm_resolution`        | uint    | Resolution of the PWM driver (for example number of ticks for a full period). Must be in range (0, 450). If not specified, the driver will attempt to estimate the resolution. |
