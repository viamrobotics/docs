...
- `extra` [(map[string]interface{})](o.dev/blog/maps>): Extra options to pass to the underlying RPC call.
...
- (map[[string]](kg.go.dev/builtin#string)[float32](https://pkg.go.dev/builtin#float32)>): The accuracy and/or precision of the sensor, if supported.
  Contents depend on sensor model.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
- ([Mapping [str, Any]](ocs.python.org/3/glossary.html#term-mapping>)): An object containing the measurements from the sensor.
...
- (map[[string]](kg.go.dev/builtin#string)interface{}>): A map containing the measurements from the sensor.
    Contents depend on sensor model and can be of any type.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
