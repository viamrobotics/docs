...
| `i2c_name` | string | **Required** | The `name` of the inter-integrated circuit (I2C) bus on your GPIO board where the connection to the `pca9685` device is made. See configuration info [here](/components/board/#i2cs). |
| `i2c_address` | int | Optional | The `pca9685`'s I2C address. |
