...
- `names` [(List[str])](s://docs.python.org/3/library/stdtypes.html#typesseq-list>) An list containing the `"name"` of every analog reader [configured](#configuration) on the board.
...
- `names` [(List[str])](s://docs.python.org/3/library/stdtypes.html#typesseq-list>) A list containing the `"name"` of every interrupt [configured](#configuration) on the board.
...
- `extra` [(Optional[Dict[str, Any]])](s://docs.python.org/library/typing.html#typing.Optional>) Extra options to pass to the underlying RPC call.
- `duration` [(Optional[datetime.timedelta])](s://docs.python.org/3/library/typing.html#typing.Optional>) If provided, the board will exit the given power mode after the specified duration.
- `timeout` [(Optional[float])](s://docs.python.org/library/typing.html#typing.Optional>) An option to set how long to wait (in seconds) before calling a time-out and closing the underlying RPC call.
