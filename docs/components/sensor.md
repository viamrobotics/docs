...
Viam has a separate, more specific component type called *movement sensor* specifically for Global Positioning System (GPS) units, IMUs, and other sensors that detect position, velocity, and acceleration.
