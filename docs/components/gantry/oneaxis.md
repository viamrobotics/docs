...
| `limit_pins`  | Optional | The `boards`'s pins attached to the limit switches on either end. If motor type is [stepper](/components/motor/gpiostepper/), `limit_pins` are required. |
