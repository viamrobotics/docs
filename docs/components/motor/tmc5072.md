...
<img src="../../img/motor/tmc5072-config-ui.png" alt="Config panel for a TMC5072 motor with attributes filled in according to the JSON Template tab." style="max-width:900px;width:100%">
