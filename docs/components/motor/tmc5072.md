...
{{< imgproc src="/icons/components/motor/tmc5072-config-ui.png" alt="Config panel for a TMC5072 motor with attributes filled in according to the Raw JSON tab." resize="1000x" >}}
