...
The `28byj48` model of the motor component supports small [stepper motors](https://en.wikipedia.org/wiki/Stepper_motor) controlled by stepper motor drivers like [ULN2003](https://www.ti.com/product/ULN2003A) that take coil input through GPIO and move the motor when they receive a step sequence.
