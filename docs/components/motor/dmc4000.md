...
Example configuration for a stepper motor driven by a DMC4000 motion controller:
...
`controller_axis` | string | A-H; select which "axis" the motor is connected to on the controller.
