...
You can drive other types of motors with Viam and the DMC-40x0 controller by [creating a custom motor model](/extend/).
...
{{< imgproc src="/icons/components/motor/dmc4000-config-ui.png" alt="A DMC4000 motor config with the attributes configured per the Raw JSON on the next tab in this doc." resize="1000x" declaredimensions=true >}}
