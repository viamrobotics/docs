...
{{< imgproc src="/icons/components/motor/gpio-config-ui.png" alt="G P I O motor config in the builder UI with the In1 and In2 pins configured and the PWM pin field left blank." resize="1000x" >}}
...
{{< imgproc src="/icons/components/motor/motor-gpio-json.png" alt="Same example JSON as on the JSON example tab, with notes alongside it. See attribute table below for all the same information." resize="1000x" >}}
