...
This controller can have [Controls](/appendix/apis/components/input-control/#control-field) defined in `attributes`, as seen in the "JSON Template" tab below.
...
| `controls` | array | Optional | Set the [Controls](/appendix/apis/components/input-control/#control-field) that are present on the controller. |
