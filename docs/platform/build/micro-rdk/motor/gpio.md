...
You can configure [encoders](/platform/build/micro-rdk/encoder/) to work with `gpio` motors.
Find more information in the [encoded motor documentation](/platform/build/configure/components/motor/gpio/encoded-motor/).

To configure a DC motor as a component of your robot, first configure the [board](/platform/build/micro-rdk/board/) to which the motor driver is wired.
Then add your motor:
...
| ---- | ---- | --------- | ----------- |
| `board` | string | **Required** | `name` of the [board](/platform/build/micro-rdk/board/) to which the motor driver is wired. |
...
See [PWM signals on `esp32` pins](/platform/build/micro-rdk/board/esp32/#pwm-signals-on-esp32-pins) for more information.
