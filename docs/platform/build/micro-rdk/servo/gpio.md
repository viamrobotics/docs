...
![An example configuration for a gpio servo in the Viam app Config Builder.](/platform/build/configure/components/servo/gpio-servo-ui-config.png)
...
| `board` | string | **Required** | `name` of the [board](/platform/build/micro-rdk/board/) the servo is wired to. |
