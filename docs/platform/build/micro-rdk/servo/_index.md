...
For more information and models supported by the {{< glossary_tooltip term_id="rdk" text="RDK" >}}, see [Servo Component](/platform/build/configure/components/servo/).
...
The micro-RDK [servo API](/platform/build/configure/components/servo/#api) supports the following client SDK API methods, which operate the same as in the full-featured RDK:

- [`Move()`](/platform/build/configure/components/servo/#move)
- [`GetPosition()`](/platform/build/configure/components/servo/#getposition)
- [`Stop()`](/platform/build/configure/components/servo/#stop)
