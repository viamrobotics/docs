...
{{< relatedcard link="/platform/build/configure/services/slam/" >}}
...
Unlike most Viam [component APIs](/platform/build/program/apis/#component-apis), the methods of the Go camera client do not map exactly to the names of the other SDK's camera methods.
...
Get all the geometries associated with the camera in its current configuration, in the [frame](/platform/build/configure/services/frame-system/) of the camera.
