...
![Configuration of an transform view in the Viam app config builder.](/platform/build/configure/components/camera/configure-transform.png)
...
Classifications overlay text from the `GetClassifications` method of the [vision service](/platform/build/configure/services/vision/) onto the image.
...
- `classifier_name`: The name of the classifier in the [vision service](/platform/build/configure/services/vision/).
...
The Detections transform takes the input image and overlays the detections from a given detector configured within the [vision service](/platform/build/configure/services/vision/).
...
- `detector_name`: The name of the detector configured in the [vision service](/platform/build/configure/services/vision/).
