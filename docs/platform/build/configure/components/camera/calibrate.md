...
2. Take images of the checkerboard with your camera from various angles and distances that show the entire image, including the edges.
   ...
   ![Example of good images](/platform/build/configure/components/camera/calibrate/ExampleImages.png)
...
{{<imgproc src="/platform/build/configure/components/camera/camera_tutorial_copy_paste.png" resize="800x" declaredimensions=true alt="Config tab with configuration snippet highlighted">}}
