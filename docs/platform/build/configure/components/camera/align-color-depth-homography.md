...
![Configuration of an align color depth homography view in the Viam app config builder.](/platform/build/configure/components/camera/configure-align-color-depth-homography.png)
