...
![Configuration of an align color depth extrinsics view in the Viam app config builder.](/platform/build/configure/components/camera/configure-align-color-depth-extrinsics.png)
