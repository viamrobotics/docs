...
If you are using a CSI camera v1.3 or v2.0 on a Raspberry Pi, you need to [enable legacy mode](/platform/get-started/installation/prepare/rpi-setup/#enable-communication-protocols).
