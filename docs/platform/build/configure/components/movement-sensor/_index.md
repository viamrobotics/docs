...
Viam also supports generic [sensors](/platform/build/configure/components/sensor/) and [encoders](/platform/build/configure/components/encoder/).
...
{{< cards >}}
{{< relatedcard link="/platform/build/configure/services/sensors/" >}}
{{< relatedcard link="/platform/build/configure/services/motion/" >}}
{{< relatedcard link="/platform/build/configure/services/navigation/" >}}
{{< /cards >}}
...
[`viam_visual_odometry`](./viam-visual-odometry/) | A [modular resource](/platform/registry/) that derives movement data from a [camera](/platform/build/configure/components/camera/) stream
...
[`wheeled-odometry`](./wheeled-odometry/) | A model that uses [encoders](/platform/build/configure/components/encoder/) to get an odometry estimate from a wheeled base
...
If you are using the micro-RDK, navigate to [Micro-RDK Movement Sensor](/platform/build/micro-rdk/movement-sensor/) for supported model information.
...
Get all the geometries associated with the movement sensor in its current configuration, in the [frame](/platform/build/configure/services/frame-system/) of the movement sensor.
...
Try adding a movement sensor to your [mobile robot](/platform/build/configure/components/base/) and writing some code with our [SDKs](/platform/build/program/apis/) to implement closed-loop movement control for your robot.

Or, try configuring [data capture](/platform/build/configure/services/data/) on your movement sensor.
