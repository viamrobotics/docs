...
![Web UI configuration panel for an arm of model yahboom-dofbot in the Viam app, with Attributes & Depends On dropdowns and the option to add a frame.](/platform/build/configure/components/arm/yahboom-dofbot-ui-config.png)
