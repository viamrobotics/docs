...
- Most of the arm drivers for the Viam RDK bypass any onboard inverse kinematics, and use Viam's [motion service](/platform/build/configure/services/motion/) instead.
...
- When you configure a supported arm model to connect to `viam-server`, the Arm driver will load and parse the kinematics file for the Viam RDK's [frame system](/platform/build/configure/services/frame-system/) service to use.

- The [frame system](/platform/build/configure/services/frame-system/) will allow you to easily calculate where any part of your robot is relative to any other part, other robot, or piece of the environment.
...
If none of the existing models fit your use case, you can [create a modular resource](/platform/registry/) to add support for it.

You can follow [this guide](/platform/registry/examples/custom-arm/) to implement your custom arm as a [modular resource](/platform/registry/).
...
Get all the geometries associated with the arm in its current configuration, in the [frame](/platform/build/configure/services/frame-system/) of the arm.
