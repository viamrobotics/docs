...
![An example configuration for a fake generic component in the Viam app Config Builder.](/platform/build/configure/components/generic/fake-generic-ui-config.png)
