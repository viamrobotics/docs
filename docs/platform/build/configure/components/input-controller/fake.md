...
![An example configuration for a fake input controller component in the Viam App config builder.](/platform/build/configure/components/input-controller/fake-input-controller-ui-config.png)
