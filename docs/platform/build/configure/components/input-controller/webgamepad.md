...
![An example configuration for a web-based gamepad input controller component in the Viam App config builder](/platform/build/configure/components/input-controller/webgamepad-input-controller-ui-config.png)
