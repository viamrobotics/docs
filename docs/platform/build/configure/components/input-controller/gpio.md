...
![An example configuration for a GPIO input controller component in the Viam App config builder](/platform/build/configure/components/input-controller/gpio-input-controller-ui-config.png)
