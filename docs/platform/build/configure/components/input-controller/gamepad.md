...
![An example configuration for a linux-based gamepad input controller component in the Viam App config builder](/platform/build/configure/components/input-controller/gamepad-input-controller-ui-config.png)
