...
![An example configuration for a multiplexed input controller component in the Viam App config builder](/platform/build/configure/components/input-controller/mux-input-controller-ui-config.png)
