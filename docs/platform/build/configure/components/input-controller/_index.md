...
- A component that you can direct the input to control, like an [arm](/platform/build/configure/components/arm/) or [motor](/platform/build/configure/components/motor/).
...
Get all the geometries associated with the input controller in its current configuration, in the [frame](/platform/build/configure/services/frame-system/) of the input controller.
