...
Configure a `multi-axis` gantry to integrate a gantry made up of multiple [`single-axis`](/platform/build/configure/components/gantry/single-axis/) gantries into your robot:
...
![Creation of a multi-axis gantry component in the Viam app config builder.](/platform/build/configure/components/gantry/multi-axis-ui-config.png)
...
| --------- | ---- | --------- | ----------- |
| `subaxes_list` | array | **Required** | An array of the `name` of each of the sub-axes, the [`single-axis`](/platform/build/configure/components/gantry/single-axis/) gantries that make up the `multi-axis` gantry. |
