...
![Creation of a sensirion-sht3xd sensor in the Viam app config builder.](/platform/build/configure/components/sensor/sensirion-sht3xd-sensor-ui-config.png)
...
| --------- | ---- | --------- | ----------- |
| `i2c_bus` | string | **Required** | The index of the [I2C bus](/platform/build/configure/components/board/#i2cs) on the board that the sensor is wired to. |
