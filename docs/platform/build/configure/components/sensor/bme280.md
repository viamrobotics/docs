...
![Creation of a bme280 sensor in the Viam app config builder.](/platform/build/configure/components/sensor/bme280-sensor-ui-config.png)
...
| --------- | ---- | --------- | ----------  |
| `board` | string | **Required** | The `name` of the [board](/platform/build/configure/components/board/) the sensor is wired to. |
| `i2c_bus` | string | **Required** | The `name` of the [I2C bus](/platform/build/configure/components/board/#i2cs) on the board that the sensor is wired to. |
