...
![Fake power sensor configuration panel in the Viam app. No attributes are configured.](/platform/build/configure/components/power-sensor/fake-config-builder.png)
