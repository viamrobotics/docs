...
![ina226 power sensor configuration panel in the Viam app.](/platform/build/configure/components/power-sensor/ina226-config-builder.png)
...
| --------- | -----| --------- | ----------- |
| `i2c_bus` | integer | **Required** | The `number` of the [I<sup>2</sup>C bus](/platform/build/configure/components/board/#i2cs) that the sensor is connected to. |
