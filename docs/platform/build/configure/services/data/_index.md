...
aliases:
  - "/data-management/"
  - "/platform/build/configure/services/data-management/"
  - "/services/data/"
icon: "/platform/build/configure/services/icons/data-capture.svg"
# SME: Alexa Greenberg
---
...
{{< relatedcard link="/platform/build/configure/components/encoder/">}}
{{< relatedcard link="/platform/build/configure/components/gantry/">}}
{{< relatedcard link="/platform/build/configure/components/motor/">}}
{{< relatedcard link="/platform/build/configure/components/movement-sensor/">}}
{{< relatedcard link="/platform/build/configure/components/sensor/">}}
{{< relatedcard link="/platform/build/configure/components/servo/">}}
{{< /cards >}}
...
To configure data capture, see [data capture](/platform/build/configure/services/data/configure-data-capture/).
...
To configure cloud sync, see [configure cloud sync](/platform/build/configure/services/data/configure-cloud-sync/).
...
To use the data management service, [add the data management service](/platform/build/configure/services/data/configure-data-capture/#add-the-data-management-service) to your machine.
Then, [configure data capture](/platform/build/configure/services/data/configure-data-capture/) and [configure cloud sync](/platform/build/configure/services/data/configure-cloud-sync/) as needed.

For a comprehensive tutorial on using data capture and synchronization together with the ML model service, see [Capture Data and Train a Model](/tutorials/services/data-mlmodel-tutorial/).

### View, filter, and export data

Once you have configured data capture and cloud sync, you can [view your data](/platform/data/view/) in the Viam app from the **Data** tab.

You can [filter your data](/platform/data/view/#filter-data) by several categories, including by machine name, location, or timestamp range.
You can filter your data from the **Data** tab in the Viam app or using the Viam Python SDK.

You can also [export](/platform/data/export/) your data as needed.
...
See [Query Data](/platform/data/query/) for instructions on using each of these approaches.

Only tabular data, such as [sensor](/platform/build/configure/components/sensor/) readings, can be queried in this fashion.
To search other types of data, such as images, see [Filter Data](/platform/data/view/#filter-data).

### Train and deploy machine learning

You can use data synced to the cloud to [train machine learning models](/platform/ml/train-model/) and then [deploy these models to your robots](/platform/build/configure/services/ml/) from the Viam app.
You can also [upload and use existing models](/platform/ml/upload-model/).
