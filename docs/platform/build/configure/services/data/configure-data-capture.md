...
![component config example](/platform/build/configure/services/data/data-service-component-config.png)
...
The following example shows the configuration of the remote part, in this case an [ESP32 board](/platform/build/micro-rdk/board/esp32/).
...
To sync your captured data with the cloud, [configure cloud sync](/platform/build/configure/services/data/configure-cloud-sync/).

If you have synced tabular data, such as [sensor](/platform/build/configure/components/sensor/) readings, you can [query that data with SQL or MQL](/platform/data/query/) from the Viam app or a MQL-compatible client.
