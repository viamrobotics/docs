...
aliases:
  - "/services/data/configure-cloud-sync/"
# SME: Alexa Greenberg
---
...
![service config example](/platform/build/configure/services/data/data-service-config.png)
...
To export your captured data from the cloud, see [Export Data](/platform/data/export/).
