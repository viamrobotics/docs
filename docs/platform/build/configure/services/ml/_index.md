...
modulescript: true
icon: "/platform/build/configure/services/icons/ml.svg"
# SME: Aaron Casas
---

Once you have [trained](/platform/ml/train-model/) or [uploaded](/platform/ml/upload-model/) your model, the Machine Learning (ML) model service allows you to deploy machine learning models to your machine.

You can use the following built-in model:

{{< alert title="Note" color="note" >}}
For some models, like the [Triton MLModel](/platform/registry/examples/triton/) for Jetson boards, you can configure the service to use the available CPU or GPU.
{{< /alert >}}

<!-- prettier-ignore -->
| Model | Description |
| ----- | ----------- |
| [`"tflite_cpu"` model](#create-an-ml-model-service) | Runs a tensorflow lite model that you have [trained](/platform/ml/train-model/) or [uploaded](/platform/ml/upload-model/). |

## Used With

{{< cards >}}
{{< relatedcard link="/platform/build/configure/services/vision/">}}
...
ML Models must be designed in particular shapes to work with the `mlmodel` [classification](/platform/build/configure/services/vision/classification/#configure-an-mlmodel-classifier) or [detection](/platform/build/configure/services/vision/detection/#configure-an-mlmodel-detector) model of Viam's [vision service](/platform/build/configure/services/vision/).
Follow [these instructions](/platform/registry/advanced/mlmodel-design/) to design your modular ML Model service with models that work with vision.
{{< /alert >}}
...
![Create a machine learning models service with an existing model](/platform/build/configure/services/available-models.png)
...
![Create a machine learning models service with a model to be deployed](/platform/build/configure/services/deploy-model.png)
...
If you do not want Viam to automatically deploy the `latest` version of the model, you can change the `packages` configuration in the [Raw JSON robot configuration](/platform/build/configure/configuration/#the-config-tab).
{{< /alert >}}
...
See [Program a machine](/platform/build/program/) for more information about using an SDK to control your machine.

## Next Steps

To make use of your model with your machine, add a [vision service](/platform/build/configure/services/vision/) or a {{< glossary_tooltip term_id="modular-resource" text="modular resource" >}}:

{{< cards >}}

{{% manualcard link="/platform/build/configure/services/vision/detection/#configure-an-mlmodel-detector"%}}
...
{{% /manualcard %}}
{{% manualcard link="/platform/build/configure/services/vision/classification/#configure-an-mlmodel-classifier"%}}
...
{{% card link="/platform/registry/examples/tflite-module/" customTitle="Example: TensorFlow Lite Modular Service" %}}
