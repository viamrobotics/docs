...
icon: "/platform/build/configure/services/icons/vision.svg"
...
The vision service enables your machine to use its on-board [cameras](/platform/build/configure/components/camera/) to intelligently see and interpret the world around it.
...
{{< cards >}}
{{% card link="/platform/build/configure/services/vision/detection/" %}}
{{% card link="/platform/build/configure/services/vision/classification/" %}}
{{% card link="/platform/build/configure/services/vision/segmentation" %}}
{{< /cards >}}
...
The following code examples assume that you have a robot configured with a [camera](/platform/build/configure/components/camera/) and a vision service [detector](/platform/build/configure/services/vision/detection/), [classifier](/platform/build/configure/services/vision/classification/) or [segmenter](/platform/build/configure/services/vision/segmentation/), as applicable, and that you add the required code to connect to your robot and import any required packages at the top of your code file.
