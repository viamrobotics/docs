...
icon: "/platform/build/configure/services/icons/sensor.svg"
images: ["/platform/build/configure/services/icons/sensor.svg"]
aliases:
  - "/services/sensors/"
# SME: Cheuk
---

The sensors service is a built-in service that provides a central interface to all of your robot's [sensors](/platform/build/configure/components/sensor/), regardless of the sensor model.
With it you can obtain readings from multiple sensors on your robot at once.

## Used With

{{< cards >}}
{{< relatedcard link="/platform/build/configure/components/sensor/" required="yes" >}}
{{< /cards >}}
