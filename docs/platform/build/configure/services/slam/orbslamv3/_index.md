...
How you configure `orbslamv3` depends on whether you want the SLAM service to build your map with data collected live by a [webcam](/platform/build/configure/components/camera/) or with data provided in a dataset at runtime.
...
Running `orbslamv3` in Live Data mode requires a [webcam](/platform/build/configure/components/camera/).
...
1. [Connect and configure a webcam](/platform/build/configure/components/camera/webca/)
2. [Calibrate a camera](/platform/build/configure/components/camera/calibrate/)
...
![adding orbslam3 slam service](/platform/build/configure/services/slam/add-orbslam-service-ui.png)
...
![adding orbslam3 slam service attributes box](/platform/build/configure/services/slam/add-orbslam-service-attributes-live.png)
...
![adding orbslam3 slam service attributes box](/platform/build/configure/services/slam/add-orbslam-service-attributes-offline.png)
...
| `sensors` | string[] | **Required** | Names of any configured [webcams](/platform/build/configure/components/camera/) providing data to the SLAM service. |
...
![error getting SLAM map](/platform/build/configure/services/slam/01_slam_tutorial_no_map_points.png)
