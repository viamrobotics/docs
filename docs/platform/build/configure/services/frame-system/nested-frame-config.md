...
Imagine a robotic [arm](/platform/build/configure/components/arm/) is attached to the actuator (moving part) of a [gantry](/platform/build/configure/components/gantry/).
...
![gantry frame card example for this configuration](/platform/build/configure/services/frame-system/frame_card_dyn_gantry.png)
...
![arm frame card example for this configuration](/platform/build/configure/services/frame-system/frame_card_dyn_arm.png)
