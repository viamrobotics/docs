...
Imagine a robotic [arm](/platform/build/configure/components/arm/) is attached to a table.
...
![frame card example for this configuration](/platform/build/configure/services/frame-system/frame_card_static.png)
