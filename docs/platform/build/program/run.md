...
After saving your [code sample](/platform/build/program/#hello-world-the-code-sample-tab) and adding control logic with [Viam's SDKs](/platform/build/program/apis/), run your program to control your Viam-connected robot.
...
{{<imgproc src="/platform/build/program/remotely.png" resize="800x" declaredimensions=true alt="A client connecting remotely to a robot">}}
...
For example, you can run code on your personal computer, creating a client [session](/platform/build/program/apis/sessions/), where the code running on that computer sends instructions to your robot's `viam-server` instance over the internet.
...
{{<imgproc src="/platform/build/program/on-robot.png" resize="800x" declaredimensions=true alt="A client running on a robot">}}

When connecting to a robot using the connection code from the [code sample tab](/platform/build/program/#hello-world-the-code-sample-tab), a [client session](/platform/build/program/apis/sessions/) automatically uses the [most efficient route](/platform/build/program/connectivity/) to connect to your robot, which means the favored route for commands will be over localhost.

## Run code automatically

If you want to run your code automatically when your robot boots, you can configure Viam to run your code as a [process](/platform/build/configure/configuration/#processes).
...
1. [`ssh` into your board](/platform/get-started/installation/prepare/rpi-setup/#connect-with-ssh) and install `pip`:
