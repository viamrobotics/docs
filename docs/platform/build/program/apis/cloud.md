...
The cloud app API allows you to [manage your machine fleet](/platform/fleet/) with code instead of with the graphical interface of the [Viam app](https://app.viam.com/).
With it you can
...
Mark a robot part as the [_main_ part](/platform/build/configure/parts-and-remotes/#robot-parts) of a robot.
