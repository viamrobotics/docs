...
icon: "/platform/build/configure/services/icons/sdk.svg"
...
Documentation on using these methods in your SDK code is found on each [component page](/platform/build/configure/components/) as follows:

### Arm

The [arm component](/platform/build/configure/components/arm/) supports the following methods:

{{< readfile "/static/include/components/apis/arm.md" >}}

### Base

The [base component](/platform/build/configure/components/base/) supports the following methods:

{{< readfile "/static/include/components/apis/base.md" >}}

### Board

The [board component](/platform/build/configure/components/board/) supports the following methods:

{{< readfile "/static/include/components/apis/board.md" >}}

### Camera

The [camera component](/platform/build/configure/components/camera/) supports the following methods:

{{< readfile "/static/include/components/apis/camera.md" >}}

### Encoder

The [encoder component](/platform/build/configure/components/encoder/) supports the following methods:

{{< readfile "/static/include/components/apis/encoder.md" >}}

### Gantry

The [gantry component](/platform/build/configure/components/gantry/) supports the following methods:

{{< readfile "/static/include/components/apis/gantry.md" >}}

### Generic

The [generic component](/platform/build/configure/components/generic/) supports the following methods:

{{< readfile "/static/include/components/apis/generic.md" >}}

### Gripper

The [gripper component](/platform/build/configure/components/gripper/) supports the following methods:

{{< readfile "/static/include/components/apis/gripper.md" >}}

### Input Controller

The [input controller component](/platform/build/configure/components/input-controller/) supports the following methods:

{{< readfile "/static/include/components/apis/input-controller.md" >}}

### Motor

The [motor component](/platform/build/configure/components/motor/) supports the following methods:

{{< readfile "/static/include/components/apis/motor.md" >}}

### Movement Sensor

The [movement sensor component](/platform/build/configure/components/movement-sensor/) supports the following methods.
...
The [power sensor component](/platform/build/configure/components/power-sensor/) supports the following methods:

{{< readfile "/static/include/components/apis/power-sensor.md" >}}

### Sensor

The [sensor component](/platform/build/configure/components/sensor/) supports the following methods:

{{< readfile "/static/include/components/apis/sensor.md" >}}

### Servo

The [servo component](/platform/build/configure/components/servo/) supports the following methods:
...
Documentation on using these methods in your SDK code is found on [service pages](/platform/build/configure/services/) as follows:

### Base Remote Control

The [base remote control service](/platform/build/configure/services/base-rc/) supports the following methods:

{{< readfile "/static/include/services/apis/base-rc.md" >}}

### Data Management

The [data management service](/platform/build/configure/services/data/) supports the following methods:

{{< readfile "/static/include/services/apis/data.md" >}}

### MLModel

The [ML model service](/platform/build/configure/services/ml/) supports the following methods:

{{< readfile "/static/include/services/apis/ml.md" >}}

### Motion

The [motion service](/platform/build/configure/services/motion/) supports the following methods:

{{< readfile "/static/include/services/apis/motion.md" >}}

### Navigation

The [navigation service](/platform/build/configure/services/navigation/) supports the following methods:

{{< readfile "/static/include/services/apis/navigation.md" >}}

### Sensors

The [sensors service](/platform/build/configure/services/sensors/) supports the following methods:
...
Different [vision service](/platform/build/configure/services/vision/) models support different methods:
...
In addition to the [board API](#board), the [board component](/platform/build/configure/components/board/) supports the following methods for interfacing with GPIO pins on a board:

{{< readfile "/static/include/components/apis/gpiopin.md" >}}

### Analog-to-Digital Converters (ADCs)

In addition to the [board API](#board), the [board component](/platform/build/configure/components/board/) supports the following methods for interfacing with [ADCs](/platform/build/configure/components/board/#analogs) on a board:

{{< readfile "/static/include/components/apis/analogreader.md" >}}

### Digital Interrupts

In addition to the [board API](#board), the [board component](/platform/build/configure/components/board/) supports the following methods for interfacing with [digital interrupts](/platform/build/configure/components/board/#digital_interrupts) on a board:
