...
If you intend to use the [ML (machine learning) model service](/platform/build/configure/services/ml/), install the Python SDK using the `mlmodel` extra:
...
You are now ready to [start using Viam's Python SDK](/platform/build/program/)!
