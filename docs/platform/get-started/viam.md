...
A _smart machine_ in Viam consists of at least one computer, typically a [single-board computer](/platform/get-started/installation/), running `viam-server` and communicating with any hardware connected to it by signaling through digital data pins.
...
To use the Viam platform with your machine, log in to [the app](https://app.viam.com/), create a new robot, and [install](/platform/get-started/installation/) the [`viam-server`](https://github.com/viamrobotics/rdk) binary which:
...
1. Add it to your robot by [choosing the component type](/platform/build/configure/configuration/#components) (example: `camera`) and model (example: `webcam`).
2. Test it with the visual [control tab](/platform/fleet/robots/#control).
3. See any problems with in-app [logs](/platform/fleet/robots/#logs), review or roll back configuration [history](/platform/fleet/robots/#history).

After configuring your machine's hardware, you can configure [high level functionality](/platform/build/configure/services/) the same way:
...
The Viam platform provides a consistent programming interface for all machines, allowing you to [control your machines](/platform/build/program/apis/) with code in the **language of your choice**.
...
- [Components](/platform/build/configure/components/) like motors, arms, GPS
- [Services](/platform/build/configure/services/) like computer vision, motion planning, Simultaneous Localization And Mapping (SLAM)
- Cloud applications like [Fleet Management](/platform/fleet/), [Data Management](/platform/data/)
...
Viam provides [fleet management capabilities](/platform/fleet/) to help you scale your machines in production.
With it you can:
...
You can also [upload your own module to the Viam registry](/platform/registry/upload/).
...
Use [Try Viam](/platform/get-started/try-viam/).

If you already have your own machine, [set up `viam-server`](/platform/get-started/installation/) and learn how Viam helps you prototype and scale.
