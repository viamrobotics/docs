...
{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/rover-front.jpg" resize="400x" declaredimensions=true alt="The front of the assembled Viam Rover">}}
...
1. One assembled Viam Rover.
   ...
   {{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/rover-side.jpg" resize="400x" declaredimensions=true alt="The side of the assembled Viam Rover">}}

1. Four M2.5 screws for mounting your Raspberry Pi.

   {{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/screws.jpg" resize="200x" declaredimensions=true alt="Four screws" >}}
...
1. Two spare stiffer suspension springs.
   ...
   {{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/suspension-springs.jpg" resize="200x" declaredimensions=true alt="Two suspension springs" >}}

1. Three different Allen wrenches (1.5 mm, 2 mm, and 2.5 mm) to unscrew the top and mount the Raspberry Pi.

   {{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/allen-wrenches.png" resize="180x" alt="Three allen wrenches" >}}
...
1. Ten female-to-female jumper wires.
   ...
   {{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/jumper-wires.jpg" resize="400x" declaredimensions=true alt="Ten colorful jumper wires" >}}

All together, your kit looks like this:

{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/box-contents.jpg" resize="400x" declaredimensions=true alt="A Viam Rover shipping box contents" >}}

## Rover components

### Dual drive motors with suspension and integrated motor encoders

{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/encoder-motors.jpg" resize="400x" declaredimensions=true alt="two motors with encoders" >}}

The motors come with integrated encoders.
For information on encoders, see [Encoder Component](/platform/build/configure/components/encoder/).
For more information on encoded DC motors, see [Encoded Motors](/platform/build/configure/components/motor/gpio/encoded-motor/).
...
{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/motor-driver.png" resize="400x" declaredimensions=true alt="A L298N motor driver" >}}
...
{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/webcam.jpg" resize="400x" declaredimensions=true alt="Webcam with cables" >}}

The webcam that comes with the kit is a standard USB camera device and the rover has a custom camera mount for it.
For more information, see [Camera Component](/platform/build/configure/components/camera/).

### 3D accelerometer

{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/accelerometer.jpg" resize="400x" declaredimensions=true alt="A ADXL345 accelerometer" >}}

The [ADXL345](/platform/build/configure/components/movement-sensor/adxl345/) sensor manufactured by Analog Devices is a digital 3-axis accelerometer that can read acceleration up to ±16g for high-resolution (13-bit) measurements.
You can access it with a SPI (3-wire or 4-wire) or I<sup>2</sup>C digital interface.

In Viam, you can configure it as a [movement sensor component](/platform/build/configure/components/movement-sensor/).

### Buck converter

{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/buck-converter.jpg" resize="400x" declaredimensions=true alt="A mini560 buck converter" >}}
...
{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/toggle-switch.jpg" resize="400x" declaredimensions=true alt="A toggle switch" >}}

The toggle switch comes wired to the rover and you use it to turn the power on and off.

### Battery pack

{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/battery-pack.jpg" resize="400x" declaredimensions=true alt="A battery pack" >}}
...
Install a 64-bit Raspberry Pi OS onto your Pi following our [Raspberry Pi installation guide](/platform/get-started/installation/prepare/rpi-setup/). Follow all steps as listed, including the final step, [Enable communication protocols](/platform/get-started/installation/prepare/rpi-setup/#enable-communication-protocols), which is required to enable the accelerometer on your rover.
...
{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/topless-rover.jpg" resize="500x" alt="The Viam Rover base with the top removed. The motors, chips and wires are exposed." >}}
...
![Closeup of the wiring diagram, showcasing the Pi, motor driver, accelerometer, and buck converter, wired according to the table below.](/platform/get-started/try-viam/rover-resources/viam-rover/rover-wiring-diagram.png)
...
{{<imgproc src="platform/get-started/try-viam/rover-resources/viam-rover/wiring-closeup.jpg" resize="400x" declaredimensions=true alt="closeup of the motor driver wiring" >}}
{{< /alert >}}

Then connect the camera's USB cable to the Pi.

![Wiring diagram showcasing the Pi, motors, driver, camera, and all other rover components.](/platform/get-started/try-viam/rover-resources/viam-rover/rover-wiring-diagram-full.png)

![the Pi, motors, driver, and all other rover components](/platform/get-started/try-viam/rover-resources/viam-rover/rover-with-pi.jpg)
...
While the Pi boots, go to [app.viam.com](https://app.viam.com/robots) and [add a robot](/platform/fleet/robots/#add-a-new-robot).
...
To configure your rover so you can start driving it, [add the Viam Fragment to your Robot](/platform/get-started/try-viam/rover-resources/rover-tutorial-fragments/).
...
- For GPS navigation, we support NMEA (using serial and I<sup>2</sup>C) and RTK.
  ...
  See [Movement Sensor Component](/platform/build/configure/components/movement-sensor/) for more information.
- For [LiDAR laser range scanning](/platform/build/configure/services/slam/cartographer/), we recommend Velodyne, or RPlidar (including A1, which is a sub-$100 LIDAR).
