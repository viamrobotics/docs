...
weight: 20
type: "docs"
image: "/platform/get-started/installation/thumbnails/jetson-nano-dev-kit.png"
imageAlt: "Jetson Nano"
images:
  ["/platform/get-started/installation/thumbnails/jetson-nano-dev-kit.png"]
...
{{<imgproc src="platform/get-started/installation/thumbnails/jetson-nano-dev-kit.png" resize="200x" alt="The front of the NVIDIA Jetson Nano single-board computer development kit.">}}
{{<imgproc src="platform/get-started/installation/thumbnails/jetson-orin-nano.jpeg" resize="200x" alt="The front of the NVIDIA Jetson Orin Nano single-board computer development kit.">}}
</div>
