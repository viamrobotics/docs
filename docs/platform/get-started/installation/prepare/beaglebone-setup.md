...
image: "platform/get-started/installation/thumbnails/beaglebone.png"
imageAlt: "BeagleBone A I-64"
images: ["/platform/get-started/installation/thumbnails/beaglebone.png"]
no_list: true
aliases:
...
{{< imgproc alt="The front of a BeagleBone AI-64 single-board computer at a 45° angle." src="/platform/get-started/installation/beaglebone-setup/image4.png" resize="400x" declaredimensions=true >}}
</div>
...
{{% card link="/tutorials/" %}}
{{% card link="/platform/get-started/try-viam/" %}}
{{< /cards >}}
