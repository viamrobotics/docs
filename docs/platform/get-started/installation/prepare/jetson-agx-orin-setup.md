...
weight: 20
type: "docs"
image: "/platform/get-started/installation/thumbnails/jetson-agx-orin-dev-kit.png"
imageAlt: "Jetson A G X Orin Developer Kit"
images:
  ["/platform/get-started/installation/thumbnails/jetson-agx-orin-dev-kit.png"]
...
{{<imgproc src="platform/get-started/installation/thumbnails/jetson-agx-orin-dev-kit.png" alt="The grey and chunky front of the NVIDIA Jetson AGX Orin single-board computer development kit." resize="200x" declaredimensions=true >}}
</div>
...
4. Configure the camera as a [webcam](/platform/build/configure/components/camera/webcam/).
