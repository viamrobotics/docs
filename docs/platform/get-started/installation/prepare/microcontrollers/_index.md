...
If you want to program the chip directly, follow the setup instructions in [the Micro-RDK Development Setup](/platform/get-started/installation/prepare/microcontrollers/development-setup/) instead.
...
{{< cards >}}
{{% manualcard link="/platform/build/micro-rdk/board/esp32/" %}}
