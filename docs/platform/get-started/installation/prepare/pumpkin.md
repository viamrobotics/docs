...
weight: 25
type: "docs"
image: "/platform/get-started/installation/thumbnails/pumpkin.png"
imageAlt: "Pumpkin board"
images: ["/platform/get-started/installation/thumbnails/pumpkin.png"]
...
Configure your board as a [`customlinux`](/platform/build/configure/components/board/customlinux/) board to use your pin mappings file:
...
![An example configuration for a customlinux board in the Viam app Config Builder.](/platform/build/configure/components/board/customlinux-ui-config.png)
