...
images: ["/platform/data/label-dog.gif"]
webmSrc: "/platform/data/label-dog.webm"
mp4Src: "/platform/data/label-dog.mp4"
...
- [Bounding boxes](#bounding-boxes), which you can use to [train object detection models](/platform/ml/train-model/#train-a-model).
- [Image tags](#image-tags), which you can use to [image classification models](/platform/ml/train-model/#train-a-model).

### Bounding boxes

You can create one or more bounding boxes for objects in each image.
If you annotate an entire dataset, you can use these bounding boxes to [create object detection models](/platform/ml/train-model/#train-a-model).
...
{{<gif webm_src="/platform/data/label-dog.webm" mp4_src="/platform/data/label-dog.mp4" alt="Add a bounding box around the dog in an image">}}

If you want to expand the image, click on the expand side menu arrow in the corner of the image:

{{<gif webm_src="/platform/data/label-dog-big.webm" mp4_src="/platform/data/label-dog-big.mp4" alt="Add a bounding box around the dog in an image in a big menu">}}
...
You can use tags to [create classification models](/platform/ml/train-model/#train-a-model) for images.
...
{{<gif webm_src="/platform/data/tag-star.webm" mp4_src="/platform/data/tag-star.mp4" alt="Tag image with a star label">}}
...
{{<gif webm_src="/platform/data/add-to-dataset.webm" mp4_src="/platform/data/add-to-dataset.mp4" alt="Add image to dataset">}}
...
![Create dataset UI](/platform/data/create-dataset.png)

### Remove an image from a dataset

To remove an image from a dataset click on the delete button next to the dataset name.

{{<gif webm_src="/platform/data/delete-from-dataset.webm" mp4_src="/platform/data/delete-from-dataset.mp4" alt="Remove from dataset">}}
...
To train a model on a dataset, see [Train a model](/platform/ml/train-model/).
...
{{< cards >}}
{{% card link="/platform/ml/train-model/" %}}
