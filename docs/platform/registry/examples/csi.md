...
These cameras are excellent for utilizing embedded vision systems like Viam's [vision service](/platform/build/configure/services/vision/).
Not all CSI cameras are supported by the built-in [webcam camera model](/platform/build/configure/components/camera/webcam/).
...
Check the [**Logs** tab](/platform/build/program/debug/) of your robot in the Viam app to make sure your camera has connected and no errors are being raised.
