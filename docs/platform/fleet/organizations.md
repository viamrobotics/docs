...
You can also use organizations for departments or other entities that can have one or more [locations](/platform/fleet/locations/).
...
When uploading [custom modules](/platform/registry/) to the Viam registry, you must set a namespace for your organization to associate your module with.
