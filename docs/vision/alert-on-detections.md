...
5. Add notification methods:
   ...
   **Webhook**: Click **Add Webhook**, enter the URL of your cloud function, and implement logic to process the [webhook payload](/reference/configuration/triggers/#webhook-attributes). Use this to integrate with external services like Twilio, PagerDuty, or Zapier.
...
- [Triggers Reference](/reference/configuration/triggers/) -- full documentation for trigger types, webhook payloads, and configuration options.
