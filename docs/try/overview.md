...
| ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ----------- |
| [Viam 101](https://www.viam.com/viam-101)               | Learn robotics fundamentals for working with physical spaces and motion planning, and build an application for a robotic arm in the Viam framework using your own control logic. | None (Viam visualization)                        | ~90 minutes |
...
| [Viam Rover](/try/viam-rover/overview/)                 | Use one of Viam's SDKs to control a rover remotely.                                                                                                                              | None (check one out in our lab)                  | ~10 minutes |
