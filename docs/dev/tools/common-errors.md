...
- If you are the module author, consider packaging the module with required dependencies so they don't need to be downloaded on startup.
  For Python modules, you can package your module with dependencies by using the PyInstaller steps when [uploading your module](/operate/modules/support-hardware/#upload-your-module).
