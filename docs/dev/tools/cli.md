...
| Command option | Description | Positional arguments |
| -------------- | ----------- | -------------------- |
| `export tabular` | Export tabular or sensor data to a specified location. You can copy this from the UI with a filter. See [Copy `export` command](#copy-export-command). | - |
| `export binary` | Export binary or image data to a specified location. You can copy this from the UI with a filter. See [Copy `export` command](#copy-export-command). | - |
