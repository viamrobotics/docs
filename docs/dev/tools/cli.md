...
| `--token` | GitHub token with repository code read access, and GitHub action read and write access. Required for private repos, not necessary for public repos. | `build start` | Optional |
