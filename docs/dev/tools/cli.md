...
The `infer` command enables you to run [cloud inference](/data-ai/ai/run-inference/#cloud) on data. Cloud inference runs in the cloud, instead of on a local machine.
