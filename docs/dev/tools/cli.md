...
- Use the `--public-namespace` argument to supply the [namespace of your organization](/operate/getting-started/other-hardware/naming-modules/#create-a-namespace-for-your-organization).
...
| Command option | Description | Positional arguments |
| -------------- | ----------- | -------------------- |
| `list` | List all organizations (name, ID, and [namespace](/operate/getting-started/other-hardware/naming-modules/#create-a-namespace-for-your-organization)) that the authenticated session has access to. | - |
