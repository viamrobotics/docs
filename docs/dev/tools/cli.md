...
- Use the `--public-namespace` argument to supply the [namespace of your organization](/operate/modules/advanced/naming-modules/#create-a-namespace-for-your-organization).
...
See [Create a module](/operate/modules/create-module/) and [Update and manage modules you created](/operate/modules/advanced/manage-modules/) for a detailed walkthrough of the `viam module` commands.
...
| Command option | Description | Positional arguments |
| -------------- | ----------- | -------------------- |
| `list` | List all organizations (name, ID, and [namespace](/operate/modules/advanced/naming-modules/#create-a-namespace-for-your-organization)) that the authenticated session has access to. | - |
