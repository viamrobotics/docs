...
aliases:
  ...
  - /operate/reference/components/arm/xarm7/
component_description: "Supports UFACTORY xArm 7."
# SMEs: Bucket, Motion
---

Configure an `xArm7` arm to integrate a [UFACTORY xArm 7](https://www.ufactory.us/product/ufactory-xarm-7) into your machine.
