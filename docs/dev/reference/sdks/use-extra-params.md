...
If `extra` information must be passed to a resource, it is handled within a new, _modular_ resource model's [custom API](/operate/get-started/other-hardware/create-module/) wrapper.
...
Follow the steps in the [Modular Resources documentation](/operate/get-started/other-hardware/create-module/) to do so.
...
See [Create a module](/operate/get-started/other-hardware/create-module/) for more information and instructions on modifying built-in API specifications.
