...
{{% changelog color="changed" title="Camera error messages display properly" date="2026-03-16" %}}

Camera error messages on the **CONTROL** tab now display properly instead of being hidden behind a frozen video frame.
