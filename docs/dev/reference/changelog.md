...
You can now update microcontroller firmware from anywhere using the [OTA update service](/operate/reference/viam-micro-server/manage-micro/#over-the-air-updates).
