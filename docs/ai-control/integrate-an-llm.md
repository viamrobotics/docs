...
- A machine with the components and services your robot uses (for example a [base](/dev/reference/apis/components/base/) and an [arm](/dev/reference/apis/components/arm/)), already [configured](/operate/get-started/supported-hardware/).
