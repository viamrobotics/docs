...
To complete the frame configuration for your machine following this example, navigate to the **CONFIGURE** tab on your machine's page in [the Viam app](https://app.viam.com), select the **Builder** mode, scroll to `myGantry`'s card, and click **Add Frame**:
