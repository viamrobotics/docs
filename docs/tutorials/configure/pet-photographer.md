...
1. Inside of the `module` directory, [compile the executable](/operate/get-started/other-hardware/create-module/#test-your-module-locally) that runs your module.
...
For more information, refer to [Write your new resource model definition](/operate/get-started/other-hardware/create-module/#write-your-module).
...
For more information, see [Write your new resource model definition](/operate/get-started/other-hardware/create-module/#write-your-module).
...
For more information, see [Create a new module](/operate/get-started/other-hardware/create-module/).

Once you've written your filter module, [compile your module into a single executable](/operate/get-started/other-hardware/create-module/#test-your-module-locally) that runs your module when executed.
