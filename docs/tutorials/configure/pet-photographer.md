...
- A computer
- A [webcam](/reference/components/camera/webcam/) or other type of [camera](/reference/components/camera/)
...
For more information, refer to [Write your new resource model definition](/build-modules/write-a-driver-module/#2-implement-the-resource-api).
...
For more information, see [Write your new resource model definition](/build-modules/write-a-driver-module/#2-implement-the-resource-api).
...
Once you've written your filter module, [compile your module into a single executable](/build-modules/write-a-driver-module/#3-test-locally) that runs your module when executed.
