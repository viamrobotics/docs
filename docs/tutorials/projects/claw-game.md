...
- Add a camera and use the [vision service](/data-ai/reference/vision/) to add color detection, or use an [ML model](/data-ai/ai/deploy/) to determine grab success rate and create a score counter.
