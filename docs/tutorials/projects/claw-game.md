...
- Add a camera and use the [vision service](/operate/reference/services/vision/) to add color detection, or use an [ML model](/data-ai/train/deploy/) to determine grab success rate and create a score counter.
