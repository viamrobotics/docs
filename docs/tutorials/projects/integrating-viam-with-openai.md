...
The [ML model service](/data-ai/train/deploy/) allows you to deploy a machine learning model to your robot.
...
- Use Viam's [Data Management](/data-ai/edge/capture-sync/) to collect environmental data and use this data to train new ML models that allow the robot to improve its functionality.
