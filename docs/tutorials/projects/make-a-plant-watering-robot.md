...
Your Pi must run a [Viam-compatible operating system](/operate/get-started/basics/#what-platforms-does-viam-run-on), and you must have SSH access.
...
while True:
    ...
    if (soil_moisture > DRY):
        ...
        motor_control_pin =
            await local.gpio_pin_by_name(name=MOTOR_CONTROL_GPIO)
