...
Get the machine address, API key, and API key ID from the **CONNECT** tab's **API keys** page and set them as environment variables or add them at the top of <FILE>chocolate_security.py</FILE>.
