...
When someone comes to your desk, the robot will use the [vision service](/operate/reference/services/vision/) and the [ML model service](/data-ai/train/deploy/) to detect a person, take their photo, and text you an alert with a photo of the person.
