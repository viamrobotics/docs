...
When someone comes to your desk, the robot will use the [vision service](/data-ai/reference/vision/) and the [ML model service](/services/ml/) to detect a person, take their photo, and text you an alert with a photo of the person.
