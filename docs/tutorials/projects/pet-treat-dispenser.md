...
Once the model has finished training, deploy it by adding an [ML model service](/services/ml/#tabset-servicesml-1-1):

1. To deploy a new model onto your robot, navigate to the robot page on the Viam app.
  Navigate to the **Config** tab, then select the **Services** subtab.
