...
{{<gif webm_src="/tutorials/img/pet-treat-dispenser/3d-print-design.webm" mp4_src="/tutorials/img/pet-treat-dispenser/3d-print-design.gif" alt="Rotating 3d rendered model of the pet feeder design." class="alignright" max-width="300px" class="aligncenter">}}
