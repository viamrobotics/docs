...
This project is a good place to begin if you're new to robotics and would like to learn how to use a [servo component](/reference/components/servo/) with Viam and Viam's [Python SDK](https://python.viam.dev/).
...
Copy the sample Python code under step 2.
