...
Since we already installed the Python SDK, we can skip the first step. Toggle **Include secret** to show your robot's location secret in the generated code, then copy the code under the second step.
