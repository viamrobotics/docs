...
This project is a good place to begin if you're new to robotics and would like to learn how to use a [servo component](/platform/build/configure/components/servo/) with the Viam app and Viam's [Python SDK](https://python.viam.dev/).
...
- [Raspberry Pi with microSD card](https://a.co/d/bxEdcAT), with `viam-server` installed per our [installation guide](/platform/get-started/installation/)
- microSD card reader
...
First, install `viam-server` according to our [installation guide](/platform/get-started/installation/)
...
Create a [board component](/platform/build/configure/components/board/):
...
Create a [servo component](/platform/build/configure/components/servo/):
