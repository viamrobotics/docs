...
1. Follow the [Raspberry Pi Setup Guide](/installation/prepare/rpi-setup/) to set up the operating system.
2. Then [install `viam-server` and connect your Pi to the Viam app](/installation/#install-viam-server).
...
Before proceeding, be sure that you have [connected your Pi to the Viam app](/installation/#install-viam-server).
...
Click the [**Control** tab](/manage/fleet/robots/#control) to view the control panels for all your robot's components (in this case, just the board).
