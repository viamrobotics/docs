---
title: "Detecting Color with the SCUTTLE Robot on Viam"
...
In the Python code, you must add your robot's address and secret, which are found on the **Connect** tab of Viam at [https://app.viam.com](https://app.viam.com) in your web browser. 
Viam pre-populates the **Connect** tab with the robot name, address, and secret:<br>
