...
- **Operationalize it.** Reuse this configuration across machines with a [fragment](/hardware/fragments/), [capture data](/data/capture-sync/) from every run, and start the loop automatically with a [trigger](/reference/triggers/).
