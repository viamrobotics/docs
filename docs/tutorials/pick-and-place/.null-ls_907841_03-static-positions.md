...
3. On the switch test card, set the switch to **update config** to save the current joint positions.
4. Set the switch to **go to** to confirm the arm returns to the saved pose from any starting position.
