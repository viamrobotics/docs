...
1. In the resulting ML Model service configuration pane, select **Deploy model on machine**, then select the model you just trained from the **Models** dropdown menu.
