...
Configuring data query allows you to directly [query your data](/data-ai/data/query/#query-data-in-the-viam-app) using a compatible client (such as `mongosh`) or Grafana to access that data and visualize it.
