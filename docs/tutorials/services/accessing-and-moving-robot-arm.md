...
7. Add a **Frame** to this component.
   ...
   {{<imgproc src="/tutorials/motion/access_02_arm_config.png" resize="700x" declaredimensions=true alt="Sample robot arm configuration with several fields filled out." style="max-width: 400px" >}}
