...
**Goal**: To make a wheeled robot follow a colored line along the floor using a webcam and the Viam <a href="/data-ai/reference/vision/#detections">vision service color detector</a>.

**What you will learn**:

- How to use the [vision service](/data-ai/reference/vision/)'s [color detectors](/data-ai/reference/vision/color_detector/)
...
You'll use the [vision service color detector](/data-ai/reference/vision/color_detector/) to programmatically identify the line to follow.
...
Next, add a vision service [detector](/data-ai/reference/vision/#detections):
...
- Add a [`saturation_cutoff_pct` or a `value_cutoff_percent`](/data-ai/reference/vision/color_detector/) to your vision service parameters.
