...
In the Python code, you must add your robot's address and secret (payload), which are found on the **Code Sample** tab of the [Viam app](https://app.viam.com). Toggle **Include secret** to show this payload in the generated code.
