...
In this tutorial, you'll learn how to use the [vision service](/vision/configure/) to make a rover follow a colored object.
...
- A wheeled rover, configured with a base component.
  ...
  This tutorial uses a [SCUTTLE rover](https://www.scuttlerobot.org/shop/) as an example but you can complete this tutorial using a Yahboom 4WD Smart Robot or any other wheeled robot that can be configured as a [base component](/hardware/common-components/add-a-base/).

- An attached and configured [webcam camera](/hardware/common-components/add-a-camera/).
...
If you haven't yet installed `viam-server`, follow the [installation guide](/foundation/) to install `viam-server` on your robot before proceeding with this tutorial.
