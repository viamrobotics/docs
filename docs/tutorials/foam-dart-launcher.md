...
Use **Keyboard Disabled** to enable keyboard control (enabled is grey, disabled is red), then use A, W, S, and D on your keyboard to move your rover around. 
...
{{< figure src="../img/nerf-robot/board-low.png"  alt="Board component, G P I O section showing Low selected on the Pin State drop-down." title="Board component, GPIO section showing Low selected on the Pin State drop-down" width="800">}}

{{< figure src="../img/nerf-robot/board-displaying-high.png"  alt="Board component, G P I O section with pin 37 set to High." title="Board component, GPIO section with pin 37 set to High." width="800">}}

{{< figure src="../img/nerf-robot/board-high.png"  alt="Board component, G P I O section showing High selected on the Pin State drop-down." title="Board component, GPIO section showing High selected on the Pin State drop-down" width="800">}}
