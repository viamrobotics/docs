...
If you are using a physical board to follow along, look through the [**Supported Models**](/hardware/common-components/add-a-board/) to determine the model of component to configure.
...
If you do not have a physical board, use the [`fake` board model](/hardware/common-components/add-a-board/).
...
Look through the [**Supported Models**](/hardware/common-components/add-a-motor/) to determine the model of component to configure.
For example, if you are using a standard DC motor (brushed or brushless) wired to a typical GPIO pin-controlled motor driver, configure a [`gpio` motor](/hardware/common-components/add-a-motor/).

Follow the motor driver manufacturer's data sheet to wire your motor driver to your board and to your motor.
Follow the [model's documentation](/hardware/common-components/add-a-motor/) to configure the attributes so that the computer can send signals to the motor.

If you do not have a physical motor, use the [`fake` motor model](/hardware/common-components/add-a-motor/).
For the `fake` model, there are no required attributes.
...
The following code shows you how to control the motor's speed and direction using the [Motor API](/hardware/common-components/add-a-motor/).
