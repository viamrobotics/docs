...
- A wheeled rover, configured with a [base component](/hardware/common-components/add-a-base/).
...
If your gamepad has a dongle, plug the gamepad Bluetooth dongle into a USB port on the rover's [board](/hardware/common-components/add-a-board/).
...
Configure a [gamepad](/hardware/common-components/add-an-input-controller/):
...
Inside the `components` array of your config, add the following configuration for your [gamepad](/hardware/common-components/add-an-input-controller/):
...
To link the controller's input to the base functionality, you need to configure the [base remote control service](/reference/apis/services/base-rc/):
