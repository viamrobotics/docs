...
You do not need any hardware for this tutorial other than a computer capable of running [`viam-server`](/foundation/).

This tutorial assumes you already have a machine [configured](/foundation/).
