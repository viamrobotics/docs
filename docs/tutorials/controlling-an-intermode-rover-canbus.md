...
Now, the intermode base can receive *SetPower* commands using the same interface you'd use to send *SetPower* commands to any rover that is Viam-controlled.
