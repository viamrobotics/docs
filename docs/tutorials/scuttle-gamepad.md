...
* A pre-configured and controllable (via keyboard in Viam ([https://app.viam.com](https://app.viam.com)) SCUTTLE robot.
...
To add this controller to the robot’s config, from Viam ([https://app.viam.com](https://app.viam.com)), click on our old friend, **New COMPONENT**.
<OL>
...
Therefore, for <strong>Model</strong>, please manually enter, "gamepad," (without the quotes) then press Tab. Viam will retain your entry.</li>


<li>Click <strong>New Component</strong>. Viam opens the Component Config panel for the gamepad. </li>
<li>On the Component Config panel, leave <strong>Depends On</strong> set to empty.</li>
<li>Viam does not add any JSON Attributes to the input_controller configuration.
...
1. Click **Create Service** under **services** at the top of Viam ([https://app.viam.com](https://app.viam.com)).
...
Save the configuration and visit the control UI on Viam ([https://app.viam.com](https://app.viam.com)).
...
Each red color arrangement allows you to control the gamepad in Viam:
<table>
