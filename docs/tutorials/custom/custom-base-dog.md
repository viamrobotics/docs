...
Now that the Freenove server is set up, you will follow the [process for creating modular resources](/operate/modules/other-hardware/create-module/).
...
You can find more information in [Create a module](/operate/modules/other-hardware/create-module/).
