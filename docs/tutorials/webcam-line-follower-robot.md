...
- A single board computer [running an instance of viam-server](../../getting-started/rpi-install/)
...
If you haven’t already, please set up the Raspberry Pi per [these instructions](../../getting-started/rpi-install/).
