...
1.  If you created a [control logic module](/manage/software/control-logic/), add it to your machine.
    ...
    {{<imgproc src="/how-tos/deploy-packages/add-package.png" resize="800x" class="" style="width: 500px" declaredimensions=true alt="Configuration builder UI">}}
...
1. Select a **Pinned version type**.
   ...
   {{<imgproc src="/how-tos/deploy-packages/version.png" resize="800x" class="" style="width: 500px" declaredimensions=true alt="Module card UI">}}
