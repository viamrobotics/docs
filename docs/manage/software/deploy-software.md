...
1. Select **Insert fragment**.
   ...
   {{<imgproc src="/how-tos/deploy-packages/insert.png" resize="800x" class="fill alignleft imgzoom shadow" style="width: 250px" declaredimensions=true alt="Add fragment">}}
