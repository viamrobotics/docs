...
Machine [configuration](/operate/modules/configure-modules/) and machine [code](/reference/sdks/) is intentionally kept separate, allowing you to keep track of versioning and debug issues separately.
