...
If you wish to have the machine in a different location, you will need to create a new machine and copy the old machine's configuration to the new machine.
...
This means any captured data will be associated with the primary organization and the machines are only able to use private ML models and registry items from the primary owner.
