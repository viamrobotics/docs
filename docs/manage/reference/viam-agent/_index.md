...
| Name       | Type | Required? | Description |
| ---------- | ---- | --------- | ----------- |
| `debug` | boolean | false | TODO. Default: `false`. |
...
| `disable_viam_server` | boolean | false | TODO. Default: `false`. |
...
| `ipv4_address` | string | optional | IPv4 address. Default: `"auto"`. |
| `ipv4_dns` | string | optional | IPv4 DNS. Default: `""`. |
...
| `ssid` | string | optional | The network's SSID. Default: `""`. |
