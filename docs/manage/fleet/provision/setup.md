...
See [`viam-server` Platform requirements](/operate/install/setup/#prerequisites) and [`viam-micro-server` hardware requirements](/operate/install/setup-micro/#supported-microcontrollers).
