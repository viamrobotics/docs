...
| -------- | ----------- |
| `VIAM_JSON_PATH` | The path to the machine cloud credentials <FILE>viam.json</FILE> file to be copied to the machine. The script will also prompt you for this file if not provided. |
