...
- **Operator**: Can see and use only the [remote control tab](robots/#control).
  Cannot see or edit the [**SETUP**](robots/#setup), [**CONFIG**](robots/#config), [**HISTORY**](robots/#history), [**LOGS**](robots/#logs), [**CODE SAMPLE**](robots/#code-sampe), or [**SECURITY**](robots/#security) tabs.
