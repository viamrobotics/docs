...
You can configure the frequency individually for each component.
...
To use the Data Management Service, first [configure data capture](configure-data-capture) and then [configure cloud sync](configure-cloud-sync).
