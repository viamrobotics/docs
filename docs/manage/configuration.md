...
- [Modules](#modules): {{< glossary_tooltip term_id="module" text="Modules" >}} provide [modular resources](/modular-resources/), which are a way to add resource types or models that are not built into Viam.
