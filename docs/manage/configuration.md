...
Meanwhile the **Code Sample** tab will also update to include code for some basic interaction with that component using the Viam [SDKs](/program/get-started-sdks/).
...
After configuring your robot, you can use the [Viam SDKs](../../program/get-started-sdks/) to program and control your robot.
