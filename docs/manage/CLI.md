...
Similarly, to create a location API key, you must begin the process by creating a [location](#create-a-location-api-key) or [robot](#create-a-robot-api-key) API key.
