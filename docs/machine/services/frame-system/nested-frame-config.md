...
aliases:
  - /machine/services/frame-system/nested-frame-config/
# SMEs: Peter L, Gautham, Bijan
---

Imagine a robotic [arm](/machine/components/arm/) is attached to the actuator (moving part) of a [gantry](/machine/components/gantry/).
...
- Select **Builder** mode and [configure your gantry](/machine/components/gantry/#supported-models), then [configure your arm](/machine/components/arm/#supported-models).
...
- Keep the **Parent** frame as `world` and fill in the coordinates for **Translation** (_mm_) and **Orientation** (_deg_) according to the position and orientation of the gantry in relation to the `world` frame's origin.
  ...
  {{<imgproc src="/machine/services/frame-system/frame_card_dyn_gantry.png" resize="300x" style="max-width: 500px" alt="Gantry frame card example for this configuration">}}
...
- Select the **Parent** frame as the gantry, and fill in the coordinates for **Translation** (_mm_) and **Orientation** (_deg_) of the arm in relation to the gantry's origin:
  ...
  {{<imgproc src="/machine/services/frame-system/frame_card_dyn_arm.png" resize="300x" style="max-width: 500px" alt="Arm frame card example for this configuration">}}
