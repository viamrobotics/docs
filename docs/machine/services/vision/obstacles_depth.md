...
- First, [configure your frame system](/machine/services/frame-system/#configuration) to configure the relative spatial orientation of the components of your machine, including your [camera](/machine/components/camera/), within Viam's [frame system service](/machine/services/frame-system/).
  ...
  - You can get those parameters from your camera through the [camera API](/machine/components/camera/#getproperties).
