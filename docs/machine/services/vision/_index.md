...
icon: true
images: ["/machine/services/icons/vision.svg"]
tags: ["vision", "computer vision", "CV", "services"]
no_list: true
modulescript: true
aliases:
  - "/machine/services/vision/"
  - "/machine/services/vision/detection/"
  - "/machine/services/vision/classification/"
  - "/machine/services/vision/segmentation/"
  - "/machine/services/vision/segmentation/"
# SMEs: Bijan, Khari
---

The vision service enables your machine to use its on-board [cameras](/machine/components/camera/) to intelligently see and interpret the world around it.
...
<div class="td-max-width-on-larger-screens">
  <div class="alignright" >
    {{< imgproc alt="A white dog with a bounding box around it labeled 'Dog: 0.71'" src="/machine/services/vision/dog-detector.png" resize="300x" declaredimensions=true >}}
  </div>
</div>
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.get_detections).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/services/vision).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.get_detections_from_camera).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.get_classifications).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.get_classifications_from_camera).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.get_object_point_clouds).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/vision/client/index.html#viam.services.vision.client.VisionClient.close).
