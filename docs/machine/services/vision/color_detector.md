...
![Color detector panel with color and hue tolerance selection and a field for the segment size](/machine/services/vision/color-detector-panel.png)
...
If you intend to use the detector with a camera that is part of your machine, you can test your detector from the [**Control tab**](/app/fleet/control/) or with code:
...
2. (Optional) If you would like to see detections from the **Control tab**, configure a [transform camera](/machine/components/camera/transform/) with the following attributes:
