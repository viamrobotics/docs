...
icon: true
images: ["/machine/services/icons/base-rc.svg"]
aliases:
  - "/machine/services/base-rc/"
# SME: Eric
---

The base remote control service implements an [input controller](/machine/components/input-controller/) as a remote control for a [base](/machine/components/base/).
This uses the [`input` API](/machine/components/input-controller/#api) to make it easy to add remote drive controls for your rover or other mobile robot with a controller like a gamepad.
...
{{< relatedcard link="/machine/components/input-controller/" required="yes" >}}
...
You must configure a [base](/machine/components/base/) with a [movement sensor](/machine/components/movement-sensor/) as part of your machine to be able to use a base remote control service.
...
| ---- | ---- | --------- | ----------- |
| `base` | string | **Required** | The `name` of the [base](/machine/components/base/) you have configured for the base you are operating with this service. |
| `input_controller` | string | **Required** | The `name` of the [input controller](/machine/components/input-controller/) you have configured for the base you are operating with this service. |
...
| `max_angular_degs_per_sec` | float | Optional | The max angular velocity for the [base](/machine/components/base/) in degrees per second. |
| `max_linear_mm_per_sec` | float | Optional | The max linear velocity for the [base](/machine/components/base/) in meters per second. |
...
The following code examples assume that you have a machine configured with a [base](/machine/components/base/) named `"my_base"`, [input controller](/machine/components/input-controller/) named `"my_controller"`, and base remote control service named `"my_base_rc_service"`.
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/services/baseremotecontrol).
...
- [([]Control)](https://python.viam.dev/autoapi/viam/machine/components/input/index.html#viam.components.input.Control): A list of inputs from the controller that are being monitored for that control mode..
