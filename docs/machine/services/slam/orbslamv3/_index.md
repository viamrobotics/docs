...
tags: ["slam", "services"]
aliases:
  - "/machine/services/slam/orbslamv3/"
# SMEs: Kat, Jeremy
---
...
How you configure `orbslamv3` depends on whether you want the SLAM service to build your map with data collected live by a [webcam](/machine/components/camera/) or with data provided in a dataset at runtime.
...
Running `orbslamv3` in Live Data mode requires a [webcam](/machine/components/camera/).
...
1. [Connect and configure a webcam](/machine/components/camera/webca/)
2. [Calibrate a camera](/machine/components/camera/calibrate/)
...
![adding orbslam3 slam service](/machine/services/slam/add-orbslam-service-ui.png)
...
![adding orbslam3 slam service attributes field](/machine/services/slam/add-orbslam-service-attributes-live.png)
...
![adding orbslam3 slam service attributes field](/machine/services/slam/add-orbslam-service-attributes-offline.png)
...
| `sensors` | string[] | **Required** | Names of any configured [webcams](/machine/components/camera/) providing data to the SLAM service. |
...
![error getting SLAM map](/machine/services/slam/01_slam_tutorial_no_map_points.png)
