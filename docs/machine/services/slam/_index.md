...
![Completed SLAM maps in the SLAM library tab](/machine/services/slam/view-map-page.png)
...
{{< cards >}}
{{< relatedcard link="/machine/components/camera/" alt_title="RPlidar" alt_link="https://github.com/viamrobotics/rplidar" required="yes">}}
{{< relatedcard link="/machine/components/movement-sensor/" required="no" >}}
{{< /cards >}}
...
- [(Pose)](https://python.viam.dev/autoapi/viam/machine/services/slam/index.html#viam.services.slam.Pose): A `Pose` representing the current position of the component the SLAM service is configured to source point cloud data from.
  For example, a [camera](/machine/components/camera/) named `"cam"`.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/slam/client/index.html#viam.services.slam.client.SLAMClient.get_position).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/services/slam).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/slam/client/index.html#viam.services.slam.client.SLAMClient.get_point_cloud_map).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/services/slam#Service).
...
- [(Properties)](https://python.viam.dev/autoapi/viam/proto/service/slam/index.html#viam.proto.service.slam.GetPropertiesResponse): Information about the current SLAM session. An object containing four fields:
  ...
  - `mapping_mode` [(MappingMode)](https://python.viam.dev/autoapi/viam/proto/service/slam/index.html#viam.proto.service.slam.MappingMode): Represents the [form of mapping and localizing the current session is performing](/machine/services/slam/cartographer/#use-a-live-machine). This includes creating a new map, localizing on an existing map and updating an existing map.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/slam/client/index.html#viam.services.slam.client.SLAMClient.get_properties).
...
- [(Properties)](https://pkg.go.dev/go.viam.com/rdk/machine/services/slam#Properties): Information about the current SLAM session.
  ...
  - `MappingMode` [(MappingMode)](https://pkg.go.dev/go.viam.com/rdk/machine/services/slam#MappingMode): Represents the [form of mapping and localizing the current session is performing](/machine/services/slam/cartographer/#use-a-live-machine). This includes creating a new map, localizing on an existing map and updating an existing map.
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/services/slam#Properties).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/slam/index.html#viam.services.slam.SLAMClient.get_internal_state).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/slam/client/index.html#viam.services.slam.client.SLAMClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/slam/client/index.html#viam.services.slam.client.SLAMClient.close).
