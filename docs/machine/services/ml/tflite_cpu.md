...
{{<imgproc src="/machine/services/deploy-model.png" resize="700x" alt="Create a machine learning models service with a model to be deployed">}}
...
![Create a machine learning models service with an existing model](/machine/services/available-models.png)
...
{{% alert title="Tip" color="tip" %}}
Models [trained](/app/ml/train-model/) in the Viam app meet these requirements by design.
{{% /alert %}}
