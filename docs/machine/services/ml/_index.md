...
- a model you [trained](/app/ml/train-model/)
...
For example, you can configure an [`mlmodel` vision service](/services/vision/) and a [`transform` camera](/machine/components/camera/transform/) to visualize the predictions your model makes.
...
| Model | Description |
| ----- | ----------- |
| [`tflite_cpu`](./tflite_cpu/) | Runs a TensorFlow Lite model that you have [trained](/app/ml/train-model/) or [uploaded](/ml/upload-model/) on the CPU of your machine. |
...
Follow [these instructions](/app/registry/advanced/mlmodel-design/) to design your modular ML model service with models that work with vision.
{{< /alert >}}
...
If you do not want Viam to automatically deploy the `latest` version of the model, you can edit the `"packages"` array in the [JSON configuration](/machine/configure/#the-configure-tab) of your machine.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/mlmodel/client/index.html#viam.services.mlmodel.client.MLModelClient.infer).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/services/mlmodel#Service).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/mlmodel/client/index.html#viam.services.mlmodel.client.MLModelClient.metadata).
...
- [(MLMetadata)](https://pkg.go.dev/go.viam.com/rdk@v0.11.1/machine/services/mlmodel#MLMetadata): Struct containing the metadata of the model file, such as the name of the model, what kind of model it is, and the expected tensor/array shape and types of the inputs and outputs of the model.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/mlmodel/client/index.html#viam.services.mlmodel.client.MLModelClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/services/mlmodel/client/index.html#viam.services.mlmodel.client.MLModelClient.close).
...
See the [Python documentation](https://python.viam.dev/autoapi/viam/machine/services/mlmodel/mlmodel/index.html#viam.services.mlmodel.mlmodel.MLModel) for more information about the `MLModel` service in Python.
...
{{% card link="/app/registry/examples/tflite-module/" customTitle="Example: TensorFlow Lite Modular Service" %}}
