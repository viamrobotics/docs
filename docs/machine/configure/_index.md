...
<!-- TODO: R2D2 need to update this section with updated control tab view { {<gif webm_src="/app/fleet/control.webm" mp4_src="/app/fleet/control.mp4" alt="Using the control tab">} } -->
