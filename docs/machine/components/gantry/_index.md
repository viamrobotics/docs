...
{{<imgproc src="/machine/components/gantry/gantry-illustration.png" resize="300x" declaredimensions=true alt="Example of what a multi-axis robot gantry looks like as a black and white illustration of an XX YY mechanical gantry.">}}
</div>
...
- A [board](/machine/components/board/) or [controller](/machine/components/input-controller/) component that can detect changes in voltage on GPIO pins
- A [motor](/machine/components/motor/) that can move linear rails
  - Encoded motor: See [DC motor with encoder](/machine/components/motor/gpio/encoded-motor/) and [encoder component](/machine/components/encoder/).
  - Stepper motor: See [Stepper motor](/machine/components/motor/gpiostepper/).
...
```go
import (
  "go.viam.com/rdk/machine/components/gantry"
)
```
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/gantry/gantry.html#Gantry.get_position).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/gantry#Gantry).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/gantry/gantry.html#Gantry.move_to_position).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/gantry/gantry.html#Gantry.get_lengths).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/gantry/gantry.html#Gantry.stop).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/gantry/gantry.html#Gantry.is_moving).
...
Get all the geometries associated with the gantry in its current configuration, in the [frame](/machine/services/frame-system/) of the gantry.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gantry/client/index.html#viam.components.gantry.client.GantryClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gantry/client/index.html#viam.components.gantry.client.GantryClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gantry/client/index.html#viam.components.gantry.client.GantryClient.close).
