...
aliases:
  - "/machine/components/gantry/multiaxis/"
  - "/machine/components/gantry/multi-axis/"
# SME: Rand, Martha
---

Configure a `multi-axis` gantry to integrate a gantry made up of multiple [`single-axis`](/machine/components/gantry/single-axis/) gantries into your machine:
...
![Creation of a multi-axis gantry component in the Viam app config builder.](/machine/components/gantry/multi-axis-ui-config.png)
...
| --------- | ---- | --------- | ----------- |
| `subaxes_list` | array | **Required** | An array of the `name` of each of the sub-axes, the [`single-axis`](/machine/components/gantry/single-axis/) gantries that make up the `multi-axis` gantry. |
