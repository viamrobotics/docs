...
weight: 10
aliases:
  - "/machine/components/encoder/fake/"
# SMEs: Rand
---
...
![Configuration of a fake encoder in the Viam app config builder.](/machine/components/encoder/configure-fake.png)
...
Once your encoder is configured and your machine is connected, go to the [**CONTROL** tab](/app/fleet/control/) and click on the encoder's dropdown panel.
