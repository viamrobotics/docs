...
- A [board component](/machine/components/board/) that can run a `viam-server` instance.
...
```go
import (
  "go.viam.com/rdk/machine/components/encoder"
)
```
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/encoder/client/index.html#viam.components.encoder.client.EncoderClient.get_position).
...
- `positionType` [(PositionType)](https://pkg.go.dev/go.viam.com/rdk/machine/components/encoder#PositionType): Specify whether to get the current position in ticks (`encoder.PositionTypeTicks`) or in degrees (`encoder.PositionTypeDegrees`).
...
- [(PositionType)](https://pkg.go.dev/go.viam.com/rdk/machine/components/encoder#PositionType): The type of position the encoder returns (ticks or degrees).
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.

For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/encoder#Encoder).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/encoder/client/index.html#viam.components.encoder.client.EncoderClient.reset_position).
...
- [(Properties)](https://python.viam.dev/autoapi/viam/machine/components/encoder/encoder/index.html#viam.components.encoder.encoder.Encoder.Properties): The position types supported by the encoder model.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/encoder/index.html#viam.components.encoder.Encoder.get_properties).
...
- [(map[Feature]bool)](https://pkg.go.dev/go.viam.com/rdk/machine/components/encoder#Feature): The position types supported by the encoder model.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
Get all the geometries associated with the encoder in its current configuration, in the [frame](/machine/services/frame-system/) of the encoder.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/encoder/client/index.html#viam.components.encoder.client.EncoderClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/encoder/client/index.html#viam.components.encoder.client.EncoderClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/encoder/client/index.html#viam.components.encoder.client.EncoderClient.close).
