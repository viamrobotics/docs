...
aliases:
  - "/machine/components/encoder/incremental/"
# SMEs: Rand
---
...
![Configuration of an incremental encoder in the Viam app config builder.](/machine/components/encoder/configure-incremental.png)
