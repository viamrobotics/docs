...
aliases:
  - "/machine/components/board/upboard/"
# SMEs: Susmita
---
...
2. The [pin control driver](https://github.com/up-division/pinctrl-upboard).
   This driver is necessary to stabilize the [GPIO pin mapping definition](https://github.com/up-board/up-community/wiki/Pinout) on the board, making the pin mapping identical to that of a [Raspberry Pi](/machine/components/board/pi/).
...
![An example configuration for a upboard board in the Viam app Config Builder.](/machine/components/board/upboard-ui-config.png)
