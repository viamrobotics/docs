...
aliases:
  - "/machine/components/board/pca9685/"
# SMEs: Gautham, Rand
---
...
![An example configuration for a pca9685 board in the Viam app Config Builder.](/machine/components/board/pca9685-ui-config.png)
