...
aliases:
  - "/machine/components/board/jetson/"
# SMEs: Gautham, Rand
---
...
![An example configuration for a Jetson board in the Viam app Config Builder.](/machine/components/board/jetson-ui-config.png)
