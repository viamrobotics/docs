...
aliases:
  - "/machine/components/board/beaglebone/"
# SMEs: Gautham, Rand
---
...
![An example configuration for a beaglebone board in the Viam app Config Builder.](/machine/components/board/beaglebone-ui-config.png)
