...
aliases:
  - "/machine/components/motor/roboclaw/"
# SMEs: Olivia, Rand
---
...
![A roboclaw motor config.](/machine/components/motor/roboclaw-ui-config.png)
...
| `ticks_per_rotation` | int | Optional | Number of full steps in a rotation. Update this if you connect [encoders](/machine/components/encoder/) to your controller through its EN1 and EN2 pins. <br> Default: `0` |
