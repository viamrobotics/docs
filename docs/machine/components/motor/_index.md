...
- A [board component](/machine/components/board/) to send signals to the motor driver[^dmcboard].
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.set_power).
...
For more information, see the [Go SDK docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/motor#Motor).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.go_for).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.go_to).
...
Set the current position (modified by `offset`) of an [encoded motor](/machine/components/motor/gpio/encoded-motor/) to be the new zero (home) position.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.reset_zero_position).
...
Report the position of an [encoded motor](/machine/components/motor/gpio/encoded-motor/) based on its encoder.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.get_position).
...
- [(Properties)](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.Properties): Map of feature names to supported status.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.get_properties).
...
- [(map\[Feature\][bool])](https://pkg.go.dev/go.viam.com/rdk/machine/components/motor#Feature): A map indicating whether or not the motor supports certain optional features.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/index.html#viam.components.motor.Motor.is_powered).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/motor/index.html#viam.components.motor.motor.Motor.is_moving).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/motor/index.html#viam.components.motor.motor.Motor.stop).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/client/index.html#viam.components.motor.client.MotorClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/client/index.html#viam.components.motor.client.MotorClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/motor/client/index.html#viam.components.motor.client.MotorClient.close).
