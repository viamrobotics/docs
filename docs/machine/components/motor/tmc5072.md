...
aliases:
  - "/machine/components/motor/tmc5072/"
# SMEs: Rand, James
---
...
![Config panel for a TMC5072 motor with attributes filled in according to the JSON tab.](/machine/components/motor/tmc5072-config-ui.png)
...
For more information, see the Go SDK docs on [Home()](https://pkg.go.dev/go.viam.com/rdk/machine/components/motor/tmcstepper#Motor.Home) and on [DoCommand()](https://pkg.go.dev/go.viam.com/rdk/machine/components/motor/tmcstepper#Motor.DoCommand).
...
For more information, see the Go SDK Docs on [`Jog`](https://pkg.go.dev/go.viam.com/rdk/machine/components/motor/tmcstepper#Motor.Jog) and on [`DoCommand`](https://pkg.go.dev/go.viam.com/rdk/machine/components/motor/tmcstepper#Motor.DoCommand).
