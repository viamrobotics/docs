...
tags: ["arm", "components"]
aliases:
  - "/machine/components/arm/xarmlite/"
# SMEs: Bucket, Motion
---
...
![Web UI configuration panel for an arm of model lite6 in the Viam app, with Attributes & Depends On dropdowns and the option to add a frame.](/machine/components/arm/lite6-ui-config.png)
...
See [the frame system service](/machine/services/frame-system/) for more information on utilizing and modifying the `"frame"` configuration shown in the `JSON Example` above.
