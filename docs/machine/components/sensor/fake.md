...
aliases:
  - "/machine/components/sensor/fake/"
# SME: #team-bucket
---
...
![An example configuration for a fake sensor in the Viam app Config Builder. Attributes are left blank.](/machine/components/sensor/fake-sensor-ui-config.png)
