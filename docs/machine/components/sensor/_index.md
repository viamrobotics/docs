...
1. [Movement sensors](/machine/components/movement-sensor/) for Global Positioning System (GPS) units, inertial measurement units (IMUs), and other sensors that detect position, velocity, and acceleration.
2. [Power sensors](/machine/components/power-sensor/) for sensors that can detect voltage, current, and power consumption of connected hardware.
3. [Encoders](/machine/components/encoder/) for sensors that can detect speed and direction of rotation of a motor or a joint.
...
```go
import (
  "go.viam.com/rdk/machine/components/sensor"
)
```
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/sensor/index.html#viam.components.sensor.Sensor.get_readings).
...
Get all the geometries associated with the sensor in its current configuration, in the [frame](/machine/services/frame-system/) of the sensor.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/sensor/client/index.html#viam.components.sensor.client.SensorClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/sensor/index.html#viam.components.sensor.Sensor.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/sensor/client/index.html#viam.components.sensor.client.SensorClient.close).
