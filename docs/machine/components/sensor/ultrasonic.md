...
aliases:
  - "/machine/components/sensor/ultrasonic/"
# SME: #team-bucket
---

{{< alert title="Tip" color="tip" >}}
An ultrasonic distance sensor can also be configured as a [camera](/machine/components/camera/) resource.

When configured as a camera, you can use the camera method [`GetPointCloud()`](/machine/components/camera/#getpointcloud), rather than the sensor method [`GetReadings()`](/machine/components/sensor/#getreadings).
...
![Creation of a ultrasonic sensor in the Viam app config builder.](/machine/components/sensor/ultrasonic-sensor-ui-config.png)
