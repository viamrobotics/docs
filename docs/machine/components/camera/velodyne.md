...
aliases:
  - "/machine/components/camera/velodyne/"
# SMEs: SLAM team
---
...
{{< imgproc src="/machine/components/camera/configure-velodyne.png" alt="Configuration of a velodyne camera in the Viam app config builder." resize="1200x" style="width=600x" >}}
