...
{{< relatedcard link="/machine/services/vision/" >}}
{{< relatedcard link="/machine/services/frame-system/" >}}
{{< relatedcard link="/machine/services/slam/" >}}
{{< relatedcard link="/machine/services/ml/" alt_title="Machine Learning" >}}
{{< /cards >}}
...
- ([PIL.Image](https://pillow.readthedocs.io/en/stable/reference/Image.html) or [RawImage](https://python.viam.dev/autoapi/viam/machine/components/camera/index.html#viam.components.camera.RawImage)): The requested frame.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/index.html#viam.components.camera.Camera.get_image).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/camera#Camera).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/index.html#viam.components.camera.Camera.get_images).
...
- [([]camera.NamedImage)](https://pkg.go.dev/go.viam.com/rdk/machine/components/camera#NamedImage): The list of images returned from the camera system, with the name of the imager associated with the image.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/index.html#viam.components.camera.Camera.get_point_cloud).
...
- [(Properties)](https://python.viam.dev/autoapi/viam/machine/components/camera/index.html#viam.components.camera.Camera.Properties): The properties of the camera.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/index.html#viam.components.camera.Camera.get_properties).
...
- [(Properties)](https://pkg.go.dev/go.viam.com/rdk/machine/components/camera#Properties): Properties of the particular implementation of a camera.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
Get all the geometries associated with the camera in its current configuration, in the [frame](/machine/services/frame-system/) of the camera.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/client/index.html#viam.components.camera.client.CameraClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/client/index.html#viam.components.camera.client.CameraClient.do_command).
...
For more information, see the [Go SDK Code](https://pkg.go.dev/go.viam.com/rdk/machine/components/camera).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/camera/client/index.html#viam.components.camera.client.CameraClient.close).
