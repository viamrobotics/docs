...
aliases:
  - "/machine/components/camera/image-file/"
...
![Configuration of an image file camera in the Viam app config builder.](/machine/components/camera/configure-image-file.png)
