...
aliases:
  - "/machine/components/camera/ultrasonic/"
# SME: #team-bucket
---

{{< alert title="Usage" color="tip" >}}
An ultrasonic distance sensor can also be configured as a [sensor](/machine/components/sensor/) resource.
When configured as a sensor, you can use the sensor method [`GetReadings()`](/machine/components/sensor/#getreadings), rather than the camera method [`GetPointCloud()`](/machine/components/camera/#getpointcloud).
{{< /alert >}}
...
![Creation of a ultrasonic camera in the Viam app config builder.](/machine/components/camera/configure-ultrasonic.png)
