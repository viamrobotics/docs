...
aliases:
  - "/machine/components/camera/join-pointclouds/"
...
![Configuration of a Join Point Clouds view in the Viam App config builder.](/machine/components/camera/configure-join-pointclouds.png)
