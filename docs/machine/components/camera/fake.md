...
aliases:
  - "/machine/components/camera/fake/"
...
![Configuration of a fake camera in the Viam app config builder.](/machine/components/camera/configure-fake.png)
...
{{< imgproc src="/machine/components/camera/fake-view.png" alt="Fake Camera View" resize="600x" >}}
