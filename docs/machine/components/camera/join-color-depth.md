...
aliases:
  - "/machine/components/camera/join-color-depth/"
...
![Configuration of a join color depth view in the Viam app config builder.](/machine/components/camera/configure-join-color-depth.png)
