...
aliases:
  - "/machine/components/camera/transform/"
...
![Configuration of an transform view in the Viam app config builder.](/machine/components/camera/configure-transform.png)
