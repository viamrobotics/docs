...
modulescript: true
aliases:
  - "/machine/components/power-sensor/"
# SME: #team-bucket
---
...
```go
import (
  "go.viam.com/rdk/machine/components/powersensor"
)
```
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/power_sensor/index.html#viam.components.power_sensor.power_sensor.PowerSensor.get_current).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/powersensor#PowerSensor).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/power_sensor/index.html#viam.components.power_sensor.power_sensor.PowerSensor.get_voltage).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/power_sensor/index.html#viam.components.power_sensor.power_sensor.PowerSensor.get_power).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/client/index.html#viam.components.power_sensor.client.PowerSensorClient.get_readings).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/powersensor#Readings).
...
Get all the geometries associated with the power sensor in its current configuration, in the [frame](/machine/services/frame-system/) of the power sensor.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/client/index.html#viam.components.power_sensor.client.PowerSensorClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/client/index.html#viam.components.power_sensor.client.PowerSensorClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/power_sensor/client/index.html#viam.components.power_sensor.client.PowerSensorClient.close).
