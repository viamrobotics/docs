...
aliases:
  - "/machine/components/power-sensor/fake/"
# SME: #team-bucket
---
...
![Fake power sensor configuration panel in the Viam app. No attributes are configured.](/machine/components/power-sensor/fake-config-builder.png)
