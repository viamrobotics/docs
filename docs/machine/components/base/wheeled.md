...
aliases:
  - "/machine/components/base/wheeled/"
# SMEs: Steve B
---

A `wheeled` base supports mobile robotic bases with drive motors on both sides (differential steering).
To configure a `wheeled` base as a component of your machine, first configure the [board](/machine/components/board/) controlling the base and any [motors](/machine/components/motor/) attached to the base.
...
{{< imgproc src="/machine/components/base/base-json.png" alt="JSON configuration file for a wheeled base with annotations explaining some of the attributes." resize="600x" >}}
...
![Wiring diagram showing a Raspberry Pi, motor drivers, motors, power supply, and voltage regulator for the rover](/machine/components/base/base-wiring-diagram.png)
