...
{{< imgproc src="/machine/components/base/fake-base-ui-config.png" alt="An example configuration for a fake base in the Viam app Config Builder." resize="1200x" style="width: 900px" >}}
...
See [GitHub](https://github.com/viamrobotics/rdk/blob/main/machine/components/base/fake/fake.go) for API call return specifications.
