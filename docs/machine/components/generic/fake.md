...
aliases:
  - "/machine/components/generic/fake/"
---
...
![An example configuration for a fake generic component in the Viam app Config Builder.](/machine/components/generic/fake-generic-ui-config.png)
...
See [GitHub](https://github.com/viamrobotics/rdk/blob/main/machine/components/generic/fake/generic.go) for API call return specifications.
