...
draft: true
aliases:
  - "/machine/components/movement-sensor/cameramono/"
# SMEs: Rand
---
...
The `camera_mono` model can use any single [camera](/machine/components/camera/) within its algorithm.
...
| -------------------------- | ------ | ------------ | ----------- |
| `camera`                   | string | **Required** | The `name` of the [camera](/machine/components/camera/) you want to use for visual odometry. |
