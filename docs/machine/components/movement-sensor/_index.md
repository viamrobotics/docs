...
modulescript: true
aliases:
  - /machine/components/movement-sensor/
# SME: Rand
---
...
Viam also supports generic [sensors](/machine/components/sensor/) and [encoders](/machine/components/encoder/).
...
{{< cards >}}
{{< relatedcard link="/machine/services/motion/" >}}
{{< relatedcard link="/machine/services/navigation/" >}}
{{< relatedcard link="/machine/services/slam/" >}}
{{< /cards >}}
...
[`wheeled-odometry`](./wheeled-odometry/) | A model that uses [encoders](/machine/components/encoder/) to get an odometry estimate from a wheeled base
...
```go
import (
  "go.viam.com/rdk/machine/components/movementsensor"
)
```
...
Report the current GeoPoint (latitude, longitude), as well as altitude above sea level in meters.
...
- [(GeoPoint)](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.GeoPoint): Abstract base class for protocol messages, containing latitude and longitude as floats.
- [(float)](https://docs.python.org/3/library/functions.html#float): Altitude in meters.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_position).
...
For more information, see the [Go SDK docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/movementsensor#MovementSensor).
...
- [(Vector3)](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.Vector3): A 3D vector containing three floats representing the linear velocity in the x, y and z directions in meters per second.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_linear_velocity).
...
- [(Vector3)](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.Vector3): A 3D vector containing three floats representing the angular velocity about the x, y and z axes in degrees per second.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_angular_velocity).
...
- [(Vector3)](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.Vector3): A 3D vector containing three floats representing the linear acceleration in the x, y and z directions in meters per second per second (m/s<sup>2</sup>).

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_linear_acceleration).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_compass_heading).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_orientation).
...
- [(Properties)](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/movement_sensor/index.html#viam.components.movement_sensor.movement_sensor.MovementSensor.Properties): The supported properties of the movement sensor.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_properties).
...
- [(\*movementsensor.Properties)](https://pkg.go.dev/go.viam.com/rdk/machine/components/movementsensor#Properties): The supported properties of the movement sensor.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/client/index.html#viam.components.movement_sensor.client.MovementSensorClient.get_accuracy).
...
- [(Accuracy)](https://pkg.go.dev/go.viam.com/rdk/machine/components/movementsensor#Accuracy): The precision and reliability metrics of the movement sensor, which vary depending on model.
  This type contains the following fields:
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/index.html#viam.components.movement_sensor.MovementSensor.get_readings).
...
For more information, see the [Go SDK docs for Sensor](https://pkg.go.dev/go.viam.com/rdk/machine/components/sensor#Sensor) (because `Readings` is part of the general sensor API that movement sensor wraps).
...
Get all the geometries associated with the movement sensor in its current configuration, in the [frame](/machine/services/frame-system/) of the movement sensor.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/client/index.html#viam.components.movement_sensor.client.MovementSensorClient.get_geometries).
...
```go {class="line-numbers linkable-line-numbers"}
myBase, err := movementsensor.FromRobot(machine, "my_movement_sensor")
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/client/index.html#viam.components.movement_sensor.client.MovementSensorClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/movement_sensor/client/index.html#viam.components.movement_sensor.client.MovementSensorClient.close).
...
Try adding a movement sensor to your [mobile robot](/machine/components/base/) and writing some code with our [SDKs](/program/apis/) to implement closed-loop movement control for your machine.

Or, try configuring [data capture](/app/data/) on your movement sensor.
