...
In addition to [`GetCompassHeading()`](/machine/components/movement-sensor/#getcompassheading), this model provides data for [`GetPosition()`](/machine/components/movement-sensor/#getposition) and [`GetAccuracy()`](/machine/components/movement-sensor/#getaccuracy).
...
![Creation of a `dual-gps-rtk` movement sensor in the Viam app config builder.](/machine/components/movement-sensor/dual-gps-rtk-builder.png)
...
{{<imgproc src="/machine/components/movement-sensor/movement-sensor-control-tab-dual.png" resize="800x" declaredimensions=true alt="The dual GPS movement sensor component in the control tab">}}
