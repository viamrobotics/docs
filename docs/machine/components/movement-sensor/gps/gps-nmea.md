...
aliases:
  - /machine/components/movement-sensor/gps/gps-nmea/
# SMEs: Rand
---
...
{{< imgproc src="/machine/components/movement-sensor/gps-nmea-builder.png" alt="Creation of a `gps-nmea` movement sensor in the Viam app config builder." resize="1200x" style="width:650px" >}}
...
You can use either serial communication (over USB) or I<sup>2</sup>C communication (through pins to a [board](/machine/components/board/)).
