...
modulescript: false
aliases:
  - "/machine/components/input-controller/"
# SME: James
---
...
- A component that you can direct the input to control, like an [arm](/machine/components/arm/) or [motor](/machine/components/motor/).

## Related services

{{< cards >}}
{{< relatedcard link="/machine/services/base-rc/" >}}
{{< /cards >}}
...
| [`fake`](fake/) | A model for testing, with [no physical hardware - see GitHub.](https://github.com/viamrobotics/rdk/tree/main/machine/components/input/fake) |
...
```go
import (
  "go.viam.com/rdk/machine/components/input"
)
```
...
- `control` [(Control)](https://python.viam.dev/autoapi/viam/machine/components/input/index.html#viam.components.input.Control): The [Control](#control-field) to register the function for.
- `triggers` [(List\[EventType\])](https://python.viam.dev/autoapi/viam/machine/components/input/index.html#viam.components.input.EventType): The [EventTypes](#eventtype-field) that trigger the function.
- `function` [(ControlFunction)](https://python.viam.dev/autoapi/viam/machine/components/input/index.html#viam.components.input.Controller.register_control_callback): The function to run when the specified triggers are invoked.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/input/index.html#viam.components.input.Controller.register_control_callback).
...
- `control`[(Control)](https://pkg.go.dev/go.viam.com/rdk/machine/components/input#Control): The [Control](#control-field) to register the function for.
- `ctrlFunc` [(ControlFunction)](https://pkg.go.dev/go.viam.com/rdk/machine/components/input#ControlFunction): The function to run when the specified triggers are invoked.
- `triggers` [([]EventType)](https://pkg.go.dev/go.viam.com/rdk/machine/components/input#EventType): The [EventTypes](#eventtype-field) that trigger the function.

**Returns:**

- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.

For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/input#Controller).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/input/input.html#Controller.get_events).
...
- [(map\[Control\]Event)](https://pkg.go.dev/go.viam.com/rdk/machine/components/input#Control): A map mapping the most recent Event for each Control.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
- [(List\[Control\])](https://python.viam.dev/autoapi/viam/machine/components/input/index.html#viam.components.input.Control): List of Controls provided by the controller.

For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/input/input.html#Controller.get_controls).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/_modules/viam/machine/components/input/input.html#Controller.trigger_event).
...
Get all the geometries associated with the input controller in its current configuration, in the [frame](/machine/services/frame-system/) of the input controller.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/input/client/index.html#viam.components.input.client.ControllerClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/input/client/index.html#viam.components.input.client.ControllerClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/input/client/index.html#viam.components.input.client.ControllerClient.close).
...
See [the Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/input/input/index.html#viam.components.input.EventType) for the most current version of supported `EventTypes`.
...
See [the Viam RDK](https://github.com/viamrobotics/rdk/blob/main/machine/components/input/input.go) for the most current version of supported `EventTypes`.
...
See [the Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/input/input/index.html#viam.components.input.Control) for the most current version of supported `Control` types.
...
See [Github](https://github.com/viamrobotics/rdk/blob/main/machine/components/input/input.go) for the most current version of supported `Control` types.
