...
aliases:
  - "/machine/components/input-controller/gamepad/"
# SMEs: James
---
...
If you have another controller that you want to use to control your machine, feel free to submit a PR on [Github](https://github.com/viamrobotics/rdk/blob/main/machine/components/input/input.go) with new mappings.
