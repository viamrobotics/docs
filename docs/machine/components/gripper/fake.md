...
aliases:
  - "/machine/components/gripper/fake/"
# SME: Rand
---
...
![An example configuration for a fake gripper in the Viam app Config Builder.](/machine/components/gripper/fake-gripper-ui-config.png)
...
See [GitHub](https://github.com/viamrobotics/rdk/blob/main/machine/components/gripper/fake/gripper.go) for API call return specifications.
