...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/index.html#viam.components.gripper.Gripper.open).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/gripper#Gripper).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/index.html#viam.components.gripper.Gripper.grab).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/index.html#viam.components.gripper.Gripper.stop).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/index.html#viam.components.gripper.Gripper.is_moving).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/client/index.html#viam.components.gripper.client.GripperClient.get_geometries).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/client/index.html#viam.components.gripper.client.GripperClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/gripper/client/index.html#viam.components.gripper.client.GripperClient.close).
