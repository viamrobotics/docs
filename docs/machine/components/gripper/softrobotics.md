...
aliases:
  - "/machine/components/gripper/softrobotics/"
---
...
![Creation of a softrobotics gripper component in the Viam app config builder.](/machine/components/gripper/softrobotics-ui-config.png)
...
| --------------- | ------------ | ------ | -------- |
| `board`         | **Required** | string | The `name` of the [board](/machine/components/board/) to which your gripper [control unit](https://www.softroboticsinc.com/uploads/2020/05/Tech_Sheet_coDrive_Control_Unit_-__TS-200210_Rev_B.pdf) is wired. |
...
| `analog_reader` | **Required** | string | Must be called `"psi"`. You must [configure an analog](/machine/components/board/#analogs) on your board and name it `"psi"`.                                                                                |
