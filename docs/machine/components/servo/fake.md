...
{{< imgproc src="/machine/components/servo/fake-servo-ui-config.png" alt="An example configuration for a fake servo in the Viam app Config Builder." resize="1200x" style="width:650px" >}}
...
See [GitHub](https://github.com/viamrobotics/rdk/blob/main/machine/components/servo/fake/servo.go) for API call return specifications.
