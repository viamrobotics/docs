...
As servos can use a lot of power, drawing voltage away from a [board](/machine/components/board/), you should power your servo with its own power supply in most cases.
The following shows an example wiring diagram for a hobby servo wired to a [`pi` board](/machine/components/board/pi/):
...
- A [board component](/machine/components/board/) that can run `viam-server`
- A servo
...
If your motor is coupled with an [encoder](/machine/components/encoder/), not a potentiometer, for position feedback, you should not configure it as a servo.
Check your device's data sheet and configure that type of servo as an [encoded motor](/machine/components/motor/gpio/encoded-motor/).
...
| [`gpio`](gpio/) | A hobby servo wired to any model of [board](/machine/components/board/#supported-models) besides `pi`. |
| [`pi`](pi/) | A hobby servo wired to a [Raspberry Pi board](/machine/components/board/pi/). |
...
```go
import (
  "go.viam.com/rdk/machine/components/servo"
)
```
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/servo/client/index.html#viam.components.servo.client.ServoClient.move).
...
For more information, see the [Go SDK Docs](https://pkg.go.dev/go.viam.com/rdk/machine/components/servo#Servo).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/servo/client/index.html#viam.components.servo.client.ServoClient.get_position).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/servo/client/index.html#viam.components.servo.client.ServoClient.stop).
...
- [(List[Geometry])](https://python.viam.dev/autoapi/viam/proto/common/index.html#viam.proto.common.Geometry): The geometries associated with the servo, in any order.

For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/servo/client/index.html#viam.components.servo.client.ServoClient.get_geometries).
...
- [`[]spatialmath.Geometry`](https://pkg.go.dev/go.viam.com/rdk/spatialmath#Geometry): The geometries associated with the servo, in any order.
- [(error)](https://pkg.go.dev/builtin#error): An error, if one occurred.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/servo/client/index.html#viam.components.servo.client.ServoClient.do_command).
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/machine/components/servo/client/index.html#viam.components.servo.client.ServoClient.close).
