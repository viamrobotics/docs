...
You can use either serial communication (over USB) or I<sup>2</sup>C communication (through pins to a [board](/build/configure/components/board/)).
...
| Name            | Type   | Inclusion    | Description |
| --------------- | ------ | ------------ | ------------------------ |
| `board`         | string | **Required** | The `name` of the [board](/build/configure/components/board/) to which the [I<sup>2</sup>C](/build/configure/components/board/#i2cs) connection is being made. |
