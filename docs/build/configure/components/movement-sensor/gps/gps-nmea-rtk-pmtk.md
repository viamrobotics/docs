...
The `gps-nmea-rtk-pmtk` model uses an over-the-internet correction source and sends the data over I<sup>2</sup>C to the [board](/build/configure/components/board/).
...
| ------------------------ | ------ | ------------ | ----------- |
| `board`                  | string | **Required** | The `name` of the [board](/build/configure/components/board/) connected to the sensor with [I<sup>2</sup>C](/build/configure/components/board/#i2cs). |
| `i2c_addr`               | int    | **Required** | The device's I<sup>2</sup>C address. |
| `i2c_bus`                | string | **Required** | The name of the [I<sup>2</sup>C bus](/build/configure/components/board/#i2cs) wired to the sensor. |
