...
After you configure your compontent, navigate to the [**Control** tab](/fleet/robots/#control) and select the **Component** dropdown panel.

Then _explain how to interact with the panel_.

{{<imgproc src="/build/configure/components/sensor/sensor-control-tab.png" resize="800x" declaredimensions=true alt="Image or GIF of the control tab">}}
