...
| `ticks_per_rotation` | int | Optional | Number of full steps in a rotation. Update this if you connect [encoders](/build/configure/components/encoder/) to your controller through its EN1 and EN2 pins. <br> Default: `0` |
