...
{{< cards >}}
{{< relatedcard link="/build/configure/services/vision/">}}
...
ML Models must be designed in particular shapes to work with the `mlmodel` [classification](/build/configure/services/vision/classification/#configure-an-mlmodel-classifier) or [detection](/build/configure/services/vision/detection/#configure-an-mlmodel-detector) model of Viam's [vision service](/build/configure/services/vision/).
...
To make use of your model with your machine, add a [vision service](/build/configure/services/vision/) or a {{< glossary_tooltip term_id="modular-resource" text="modular resource" >}}:
