...
aliases:
  - "/data-management/"
  - "/build/configure/services/data-management/"
  - "/services/data/"
...
To configure data capture, see [data capture](/build/configure/services/data/configure-data-capture/).
...
To configure cloud sync, see [configure cloud sync](/build/configure/services/data/configure-cloud-sync/).
...
To use the data management service, [add the data management service](/build/configure/services/data/configure-data-capture/#add-the-data-management-service) to your machine.
Then, [configure data capture](/build/configure/services/data/configure-data-capture/) and [configure cloud sync](/build/configure/services/data/configure-cloud-sync/) as needed.
...
You can use data synced to the cloud to [train machine learning models](/ml/train-model/) and then [deploy these models to your robots](/build/configure/services/ml/) from the Viam app.
