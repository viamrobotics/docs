...
![gantry frame card example for this configuration](/build/configure/services/frame-system/frame_card_dyn_gantry.png)
...
![arm frame card example for this configuration](/build/configure/services/frame-system/frame_card_dyn_arm.png)
