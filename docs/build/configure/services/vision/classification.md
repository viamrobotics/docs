...
{{<gif webm_src="/build/configure/services/vision/mug-classifier.webm" mp4_src="/build/configure/services/vision/mug-classifier.mp4" alt="A classification model run against an image containing a mug." max-width="250px" class="alignright">}}
...
If you intend to use the classifier with a camera that is part of your robot, you can test your classifier from the [**Control tab**](/fleet/robots/#control) or with code:
