...
Configure a process as follows:
...
{{%expand "Click this to see an example of a configured process." %}}
...
Now your machine will run this command automatically every time it boots.
