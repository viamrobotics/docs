...
Viam uses a composable system of building blocks called {{< glossary_tooltip term_id="resource" text="resources" >}} (components and services) so you can add the hardware drivers and the high-level software functionality you need to your robot:
...
To get started, first [install `viam-server`](/get-started/installation/) on your robot's computer.
