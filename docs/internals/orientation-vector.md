...
You use orientation vectors to specify relative orientations of components when using the [motion service](/machine/services/motion/) and [frame system](/machine/services/frame-system/).
