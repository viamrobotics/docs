...
[Encoded motors](/machine/components/motor/gpio/encoded-motor/) and [sensor controlled bases](/machine/components/base/sensor-controlled/) use a control loop that is implemented by `viam-server`.
