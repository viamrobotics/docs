...
The SLAM service in the RDK (located in /rdk/service/slam) is a wrapper for the C++ SLAM libraries mentioned above.
...
<img src="/mobility/slam-service-arch.png" alt="Flow diagram of the SLAM service architecture."/>
