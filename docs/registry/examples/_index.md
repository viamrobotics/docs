...
Once you have created a modular resource, you can test your modular resource using the [Control tab](/fleet/control/) and program it using the [Viam SDKs](/build/program/apis/).
