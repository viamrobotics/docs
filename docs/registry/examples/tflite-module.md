...
- Write a client similar to `example_audio_classification_client` that [trains its own model](/how-tos/deploy-ml/) on existing or incoming data, as long as that model fulfils the TFLite model constraints.
