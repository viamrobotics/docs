...
If you want to use most of an existing API but need just a few other functions, try using the `DoCommand` endpoint and [extra parameters](/sdks/use-extra-params/) to add custom functionality to an existing subtype.
...
1. In the root directory of your module, you need to generate some starter files.
...
{{< cards >}}
{{% manualcard link="/how-tos/create-module/#write-a-module"%}}
