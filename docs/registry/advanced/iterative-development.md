...
If you are using Cloud Build, be sure to update your [GitHub action file](/use-cases/manage-modules/#update-an-existing-module-using-a-github-action) tags to include the release candidate version.
