...
4. (Optional) [Configure a process](/build/configure/#add-a-process) to launch this remote server to ensure the remote server is always running alongside the rest of your machine.
...
1. (Optional) [Configure a process](/build/configure/#add-a-process) to launch this remote server to ensure the remote server is always running alongside the rest of your machine.
