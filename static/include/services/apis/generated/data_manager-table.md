...
| [`GetStatus`](/dev/reference/apis/services/data/#getstatus) | Get the current status of the data management service as a map of key-value pairs describing its state. |  |
