...
| [`GetStatus`](/dev/reference/apis/services/world-state-store/#getstatus) | Get the current status of the world state store service as a map of key-value pairs describing its state. |
