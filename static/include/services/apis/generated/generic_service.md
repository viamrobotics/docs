...
Get the current status of the generic service as a map of key-value pairs describing its state.
...
For more information, see the [Python SDK Docs](https://python.viam.dev/autoapi/viam/services/generic/client/index.html#viam.services.generic.client.GenericClient.get_status).
...
For more information, see the [TypeScript SDK Docs](https://ts.viam.dev/classes/GenericServiceClient.html#getstatus).
...
For more information, see the [Flutter SDK Docs](https://flutter.viam.dev/viam_sdk/GenericServiceClient/getStatus.html).
