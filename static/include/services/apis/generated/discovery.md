...
- (Promise<[ComponentConfig](https://ts.viam.dev/classes/appRobotApi.ComponentConfig.html)[]>): Implementation of [Discovery](https://ts.viam.dev/interfaces/Discovery.html).[discoverResources](https://ts.viam.dev/interfaces/Discovery.html#discoverResources).
