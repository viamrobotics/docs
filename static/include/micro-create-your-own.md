...
You will need to [build custom firmware and flash your ESP32 yourself](/reference/device-setup/setup-micro/micro-module/) instead of using Viam's prebuilt binary and installer.
{{< /alert >}}
