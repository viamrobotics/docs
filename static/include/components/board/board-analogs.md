...
ADCs are useful when building a robot, as they enable your board to read the analog signal output by most types of [sensors](/hardware/common-components/add-a-sensor/) and other hardware components.
