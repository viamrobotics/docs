Once you have configured your digital interrupts, open the board's **TEST** panel on the **CONFIGURE** or [**CONTROL**](/manage/troubleshoot/teleoperate/default-interface/#viam-app) tabs to monitor interrupt activity.
