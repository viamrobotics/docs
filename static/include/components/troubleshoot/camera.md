...
When working with a [camera](/hardware/common-components/add-a-camera/) component, depending on the camera, you may need to explicitly provide some camera-specific configuration parameters.
