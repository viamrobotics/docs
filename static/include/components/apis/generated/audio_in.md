...
Get all the geometries associated with the audio in component in its current configuration, in the [frame](/reference/services/frame-system/) of the audio in component.
...
Get the current status of the audio input component as a map of key-value pairs describing its state.
...
For more information, see the [TypeScript SDK Docs](https://ts.viam.dev/classes/AudioInClient.html#getstatus).
...
For more information, see the [Flutter SDK Docs](https://flutter.viam.dev/viam_sdk/AudioInClient/getStatus.html).
