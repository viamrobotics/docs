...
| [`Stream`](/dev/reference/apis/components/camera/#stream) | Stream live video frames from the camera. |
...
| [`GetStatus`](/dev/reference/apis/components/camera/#getstatus) | Get the current status of the camera as a map of key-value pairs describing its state. |
