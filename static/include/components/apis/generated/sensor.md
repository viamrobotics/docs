...
Get all the geometries associated with the sensor in its current configuration, in the [frame](/reference/services/frame-system/) of the sensor.
...
Get the current status of the sensor as a map of key-value pairs describing its state.
...
For more information, see the [TypeScript SDK Docs](https://ts.viam.dev/classes/SensorClient.html#getstatus).
