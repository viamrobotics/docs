...
Get the current position of the arm as a [pose](/motion-planning/).
...
Move the end of the arm in a straight line to the desired [pose](/motion-planning/), relative to the base of the arm.
...
Get the kinematics information associated with the arm as the format and byte contents of the [kinematics file](/reference/).
...
Get all the geometries associated with the arm in its current configuration, in the [frame](/reference/) of the arm.
