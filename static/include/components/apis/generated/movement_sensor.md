...
Get all the geometries associated with the movement sensor in its current configuration, in the [frame](/reference/services/frame-system/) of the movement sensor.
