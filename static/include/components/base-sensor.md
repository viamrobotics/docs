...
Alternatively, if your base has position reporting motors, you can use the [wheeled odometry](/hardware/common-components/add-a-movement-sensor/) movement sensor to get an estimate of the necessary velocities.
...
For more information on PID or to set up a more complex control loop, see the [controls package](/reference/)
