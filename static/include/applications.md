...
| ------------ | ------ | ----------- |
| `name`       | string | The name of your application, which is part of the application's URL (`name_publicnamespace.viamapplications.com`). For more information on valid names see [Valid application identifiers](/build-modules/#valid-application-identifiers). |
