...
To visualize a component without moving any real-world hardware, configure a `fake` model to represent your component (for example, a [`fake` arm](/hardware/common-components/add-an-arm/)), then follow the steps below using the fake component.
{{% /alert %}}
