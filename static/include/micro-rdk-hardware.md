...
You will also need a data cable to connect the microcontroller to your development machine, though subsequent firmware updates can be made remotely with the [over-the-air (OTA) service](/reference/device-setup/setup-micro/#configure-over-the-air-updates).
...
You can change this max by [building your own firmware](/reference/device-setup/setup-micro/#build-and-flash-custom-firmware).
{{< /alert >}}
