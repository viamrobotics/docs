...
if args.map:
    ...
    for sdk_lang in sdk_langs:
        ...
        if sdk_lang not in sdks_supported:
            ...
            print("IMPORTANT: You have indicated that you want to run against specific SDKs, instead of all.")
            ...
            print("           CANCEL this run, and re-run without specifying any SDKs to run against all.")
